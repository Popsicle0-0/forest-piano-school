 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Ki,tt,Ct,Oi,ft,Zi,Ni,Gl=function(){return typeof window<"u"},Qe={},ht=180/Math.PI,Mt=Math.PI/180,wt=Math.atan2,Xi=1e8,Ri=/([A-Z])/g,Wl=/(left|right|width|margin|padding|x)/i,jl=/[\s,\(]\S/,je={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},hi=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},zl=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Vl=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Yl=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Ul=function(e,t){var i=t.s+t.c*e;t.set(t.t,t.p,~~(i+(i<0?-.5:.5))+t.u,t)},xr=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},wr=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},Ql=function(e,t,i){return e.style[t]=i},Kl=function(e,t,i){return e.style.setProperty(t,i)},Zl=function(e,t,i){return e._gsap[t]=i},Xl=function(e,t,i){return e._gsap.scaleX=e._gsap.scaleY=i},Jl=function(e,t,i,n,r){var l=e._gsap;l.scaleX=l.scaleY=i,l.renderTransform(r,l)},eo=function(e,t,i,n,r){var l=e._gsap;l[t]=i,l.renderTransform(r,l)},le="transform",Se=le+"Origin",to=function s(e,t){var i=this,n=this.target,r=n.style,l=n._gsap;if(e in Qe&&r){if(this.tfm=this.tfm||{},e!=="transform")e=je[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return i.tfm[o]=Ye(n,o)}):this.tfm[e]=l.x?l[e]:Ye(n,e),e===Se&&(this.tfm.zOrigin=l.zOrigin);else return je.transform.split(",").forEach(function(o){return s.call(i,o,t)});if(this.props.indexOf(le)>=0)return;l.svg&&(this.svgo=n.getAttribute("data-svg-origin"),this.props.push(Se,t,"")),e=le}(r||t)&&this.props.push(e,t,r[e])},kr=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},so=function(){var e=this.props,t=this.target,i=t.style,n=t._gsap,r,l;for(r=0;r<e.length;r+=3)e[r+1]?e[r+1]===2?t[e[r]](e[r+2]):t[e[r]]=e[r+2]:e[r+2]?i[e[r]]=e[r+2]:i.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(Ri,"-$1").toLowerCase());if(this.tfm){for(l in this.tfm)n[l]=this.tfm[l];n.svg&&(n.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=Ni(),(!r||!r.isStart)&&!i[le]&&(kr(i),n.zOrigin&&i[Se]&&(i[Se]+=" "+n.zOrigin+"px",n.zOrigin=0,n.renderTransform()),n.uncache=1)}},Tr=function(e,t){var i={target:e,props:[],revert:so,save:to};return e._gsap||Le.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(n){return i.save(n)}),i},Sr,fi=function(e,t){var i=tt.createElementNS?tt.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):tt.createElement(e);return i&&i.style?i:tt.createElement(e)},Pe=function s(e,t,i){var n=getComputedStyle(e);return n[t]||n.getPropertyValue(t.replace(Ri,"-$1").toLowerCase())||n.getPropertyValue(t)||!i&&s(e,Ot(t)||t,1)||""},Ji="O,Moz,ms,Ms,Webkit".split(","),Ot=function(e,t,i){var n=t||ft,r=n.style,l=5;if(e in r&&!i)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);l--&&!(Ji[l]+e in r););return l<0?null:(l===3?"ms":l>=0?Ji[l]:"")+e},pi=function(){Gl()&&window.document&&(Ki=window,tt=Ki.document,Ct=tt.documentElement,ft=fi("div")||{style:{}},fi("div"),le=Ot(le),Se=le+"Origin",ft.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Sr=!!Ot("perspective"),Ni=Le.core.reverting,Oi=1)},en=function(e){var t=e.ownerSVGElement,i=fi("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=e.cloneNode(!0),r;n.style.display="block",i.appendChild(n),Ct.appendChild(i);try{r=n.getBBox()}catch{}return i.removeChild(n),Ct.removeChild(i),r},tn=function(e,t){for(var i=t.length;i--;)if(e.hasAttribute(t[i]))return e.getAttribute(t[i])},Lr=function(e){var t,i;try{t=e.getBBox()}catch{t=en(e),i=1}return t&&(t.width||t.height)||i||(t=en(e)),t&&!t.width&&!t.x&&!t.y?{x:+tn(e,["x","cx","x1"])||0,y:+tn(e,["y","cy","y1"])||0,width:0,height:0}:t},Cr=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Lr(e))},lt=function(e,t){if(t){var i=e.style,n;t in Qe&&t!==Se&&(t=le),i.removeProperty?(n=t.substr(0,2),(n==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),i.removeProperty(n==="--"?t:t.replace(Ri,"-$1").toLowerCase())):i.removeAttribute(t)}},st=function(e,t,i,n,r,l){var o=new Te(e._pt,t,i,0,1,l?wr:xr);return e._pt=o,o.b=n,o.e=r,e._props.push(i),o},sn={deg:1,rad:1,turn:1},io={grid:1,flex:1},ot=function s(e,t,i,n){var r=parseFloat(i)||0,l=(i+"").trim().substr((r+"").length)||"px",o=ft.style,a=Wl.test(t),d=e.tagName.toLowerCase()==="svg",c=(d?"client":"offset")+(a?"Width":"Height"),g=100,h=n==="px",m=n==="%",_,u,f,p;if(n===l||!r||sn[n]||sn[l])return r;if(l!=="px"&&!h&&(r=s(e,t,i,"px")),p=e.getCTM&&Cr(e),(m||l==="%")&&(Qe[t]||~t.indexOf("adius")))return _=p?e.getBBox()[a?"width":"height"]:e[c],ce(m?r/_*g:r/100*_);if(o[a?"width":"height"]=g+(h?l:n),u=n!=="rem"&&~t.indexOf("adius")||n==="em"&&e.appendChild&&!d?e:e.parentNode,p&&(u=(e.ownerSVGElement||{}).parentNode),(!u||u===tt||!u.appendChild)&&(u=tt.body),f=u._gsap,f&&m&&f.width&&a&&f.time===Ee.time&&!f.uncache)return ce(r/f.width*g);if(m&&(t==="height"||t==="width")){var y=e.style[t];e.style[t]=g+n,_=e[c],y?e.style[t]=y:lt(e,t)}else(m||l==="%")&&!io[Pe(u,"display")]&&(o.position=Pe(e,"position")),u===e&&(o.position="static"),u.appendChild(ft),_=ft[c],u.removeChild(ft),o.position="absolute";return a&&m&&(f=_t(u),f.time=Ee.time,f.width=u[c]),ce(h?_*r/g:_&&r?g/_*r:0)},Ye=function(e,t,i,n){var r;return Oi||pi(),t in je&&t!=="transform"&&(t=je[t],~t.indexOf(",")&&(t=t.split(",")[0])),Qe[t]&&t!=="transform"?(r=Xt(e,n),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:Ss(Pe(e,Se))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||n||~(r+"").indexOf("calc("))&&(r=Ts[t]&&Ts[t](e,t,i)||Pe(e,t)||zn(e,t)||(t==="opacity"?1:0))),i&&!~(r+"").trim().indexOf(" ")?ot(e,t,r,i)+i:r},no=function(e,t,i,n){if(!i||i==="none"){var r=Ot(t,e,1),l=r&&Pe(e,r,1);l&&l!==i?(t=r,i=l):t==="borderColor"&&(i=Pe(e,"borderTopColor"))}var o=new Te(this._pt,e.style,t,0,1,mr),a=0,d=0,c,g,h,m,_,u,f,p,y,v,b,x;if(o.b=i,o.e=n,i+="",n+="",n.substring(0,6)==="var(--"&&(n=Pe(e,n.substring(4,n.indexOf(")")))),n==="auto"&&(u=e.style[t],e.style[t]=n,n=Pe(e,t)||n,u?e.style[t]=u:lt(e,t)),c=[i,n],dr(c),i=c[0],n=c[1],h=i.match(Tt)||[],x=n.match(Tt)||[],x.length){for(;g=Tt.exec(n);)f=g[0],y=n.substring(a,g.index),_?_=(_+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(_=1),f!==(u=h[d++]||"")&&(m=parseFloat(u)||0,b=u.substr((m+"").length),f.charAt(1)==="="&&(f=Lt(m,f)+b),p=parseFloat(f),v=f.substr((p+"").length),a=Tt.lastIndex-v.length,v||(v=v||$e.units[t]||b,a===n.length&&(n+=v,o.e+=v)),b!==v&&(m=ot(e,t,u,v)||0),o._pt={_next:o._pt,p:y||d===1?y:",",s:m,c:p-m,m:_&&_<4||t==="zIndex"?Math.round:0});o.c=a<n.length?n.substring(a,n.length):""}else o.r=t==="display"&&n==="none"?wr:xr;return qn.test(n)&&(o.e=0),this._pt=o,o},nn={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},ro=function(e){var t=e.split(" "),i=t[0],n=t[1]||"50%";return(i==="top"||i==="bottom"||n==="left"||n==="right")&&(e=i,i=n,n=e),t[0]=nn[i]||i,t[1]=nn[n]||n,t.join(" ")},lo=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var i=t.t,n=i.style,r=t.u,l=i._gsap,o,a,d;if(r==="all"||r===!0)n.cssText="",a=1;else for(r=r.split(","),d=r.length;--d>-1;)o=r[d],Qe[o]&&(a=1,o=o==="transformOrigin"?Se:le),lt(i,o);a&&(lt(i,le),l&&(l.svg&&i.removeAttribute("transform"),n.scale=n.rotate=n.translate="none",Xt(i,1),l.uncache=1,kr(n)))}},Ts={clearProps:function(e,t,i,n,r){if(r.data!=="isFromStart"){var l=e._pt=new Te(e._pt,t,i,0,0,lo);return l.u=n,l.pr=-10,l.tween=r,e._props.push(i),1}}},Zt=[1,0,0,1,0,0],Mr={},Er=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},rn=function(e){var t=Pe(e,le);return Er(t)?Zt:t.substr(7).match(Fn).map(ce)},Ii=function(e,t){var i=e._gsap||_t(e),n=e.style,r=rn(e),l,o,a,d;return i.svg&&e.getAttribute("transform")?(a=e.transform.baseVal.consolidate().matrix,r=[a.a,a.b,a.c,a.d,a.e,a.f],r.join(",")==="1,0,0,1,0,0"?Zt:r):(r===Zt&&!e.offsetParent&&e!==Ct&&!i.svg&&(a=n.display,n.display="block",l=e.parentNode,(!l||!e.offsetParent&&!e.getBoundingClientRect().width)&&(d=1,o=e.nextElementSibling,Ct.appendChild(e)),r=rn(e),a?n.display=a:lt(e,"display"),d&&(o?l.insertBefore(e,o):l?l.appendChild(e):Ct.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},_i=function(e,t,i,n,r,l){var o=e._gsap,a=r||Ii(e,!0),d=o.xOrigin||0,c=o.yOrigin||0,g=o.xOffset||0,h=o.yOffset||0,m=a[0],_=a[1],u=a[2],f=a[3],p=a[4],y=a[5],v=t.split(" "),b=parseFloat(v[0])||0,x=parseFloat(v[1])||0,S,w,L,T;i?a!==Zt&&(w=m*f-_*u)&&(L=b*(f/w)+x*(-u/w)+(u*y-f*p)/w,T=b*(-_/w)+x*(m/w)-(m*y-_*p)/w,b=L,x=T):(S=Lr(e),b=S.x+(~v[0].indexOf("%")?b/100*S.width:b),x=S.y+(~(v[1]||v[0]).indexOf("%")?x/100*S.height:x)),n||n!==!1&&o.smooth?(p=b-d,y=x-c,o.xOffset=g+(p*m+y*u)-p,o.yOffset=h+(p*_+y*f)-y):o.xOffset=o.yOffset=0,o.xOrigin=b,o.yOrigin=x,o.smooth=!!n,o.origin=t,o.originIsAbsolute=!!i,e.style[Se]="0px 0px",l&&(st(l,o,"xOrigin",d,b),st(l,o,"yOrigin",c,x),st(l,o,"xOffset",g,o.xOffset),st(l,o,"yOffset",h,o.yOffset)),e.setAttribute("data-svg-origin",b+" "+x)},Xt=function(e,t){var i=e._gsap||new hr(e);if("x"in i&&!t&&!i.uncache)return i;var n=e.style,r=i.scaleX<0,l="px",o="deg",a=getComputedStyle(e),d=Pe(e,Se)||"0",c,g,h,m,_,u,f,p,y,v,b,x,S,w,L,T,C,E,A,P,$,O,R,G,Z,be,M,k,D,I,B,q;return c=g=h=u=f=p=y=v=b=0,m=_=1,i.svg=!!(e.getCTM&&Cr(e)),a.translate&&((a.translate!=="none"||a.scale!=="none"||a.rotate!=="none")&&(n[le]=(a.translate!=="none"?"translate3d("+(a.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(a.rotate!=="none"?"rotate("+a.rotate+") ":"")+(a.scale!=="none"?"scale("+a.scale.split(" ").join(",")+") ":"")+(a[le]!=="none"?a[le]:"")),n.scale=n.rotate=n.translate="none"),w=Ii(e,i.svg),i.svg&&(i.uncache?(Z=e.getBBox(),d=i.xOrigin-Z.x+"px "+(i.yOrigin-Z.y)+"px",G=""):G=!t&&e.getAttribute("data-svg-origin"),_i(e,G||d,!!G||i.originIsAbsolute,i.smooth!==!1,w)),x=i.xOrigin||0,S=i.yOrigin||0,w!==Zt&&(E=w[0],A=w[1],P=w[2],$=w[3],c=O=w[4],g=R=w[5],w.length===6?(m=Math.sqrt(E*E+A*A),_=Math.sqrt($*$+P*P),u=E||A?wt(A,E)*ht:0,y=P||$?wt(P,$)*ht+u:0,y&&(_*=Math.abs(Math.cos(y*Mt))),i.svg&&(c-=x-(x*E+S*P),g-=S-(x*A+S*$))):(q=w[6],I=w[7],M=w[8],k=w[9],D=w[10],B=w[11],c=w[12],g=w[13],h=w[14],L=wt(q,D),f=L*ht,L&&(T=Math.cos(-L),C=Math.sin(-L),G=O*T+M*C,Z=R*T+k*C,be=q*T+D*C,M=O*-C+M*T,k=R*-C+k*T,D=q*-C+D*T,B=I*-C+B*T,O=G,R=Z,q=be),L=wt(-P,D),p=L*ht,L&&(T=Math.cos(-L),C=Math.sin(-L),G=E*T-M*C,Z=A*T-k*C,be=P*T-D*C,B=$*C+B*T,E=G,A=Z,P=be),L=wt(A,E),u=L*ht,L&&(T=Math.cos(L),C=Math.sin(L),G=E*T+A*C,Z=O*T+R*C,A=A*T-E*C,R=R*T-O*C,E=G,O=Z),f&&Math.abs(f)+Math.abs(u)>359.9&&(f=u=0,p=180-p),m=ce(Math.sqrt(E*E+A*A+P*P)),_=ce(Math.sqrt(R*R+q*q)),L=wt(O,R),y=Math.abs(L)>2e-4?L*ht:0,b=B?1/(B<0?-B:B):0),i.svg&&(G=e.getAttribute("transform"),i.forceCSS=e.setAttribute("transform","")||!Er(Pe(e,le)),G&&e.setAttribute("transform",G))),Math.abs(y)>90&&Math.abs(y)<270&&(r?(m*=-1,y+=u<=0?180:-180,u+=u<=0?180:-180):(_*=-1,y+=y<=0?180:-180)),t=t||i.uncache,i.x=c-((i.xPercent=c&&(!t&&i.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-c)?-50:0)))?e.offsetWidth*i.xPercent/100:0)+l,i.y=g-((i.yPercent=g&&(!t&&i.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-g)?-50:0)))?e.offsetHeight*i.yPercent/100:0)+l,i.z=h+l,i.scaleX=ce(m),i.scaleY=ce(_),i.rotation=ce(u)+o,i.rotationX=ce(f)+o,i.rotationY=ce(p)+o,i.skewX=y+o,i.skewY=v+o,i.transformPerspective=b+l,(i.zOrigin=parseFloat(d.split(" ")[2])||!t&&i.zOrigin||0)&&(n[Se]=Ss(d)),i.xOffset=i.yOffset=0,i.force3D=$e.force3D,i.renderTransform=i.svg?ao:Sr?Ar:oo,i.uncache=0,i},Ss=function(e){return(e=e.split(" "))[0]+" "+e[1]},Gs=function(e,t,i){var n=me(t);return ce(parseFloat(t)+parseFloat(ot(e,"x",i+"px",n)))+n},oo=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Ar(e,t)},dt="0deg",Nt="0px",ut=") ",Ar=function(e,t){var i=t||this,n=i.xPercent,r=i.yPercent,l=i.x,o=i.y,a=i.z,d=i.rotation,c=i.rotationY,g=i.rotationX,h=i.skewX,m=i.skewY,_=i.scaleX,u=i.scaleY,f=i.transformPerspective,p=i.force3D,y=i.target,v=i.zOrigin,b="",x=p==="auto"&&e&&e!==1||p===!0;if(v&&(g!==dt||c!==dt)){var S=parseFloat(c)*Mt,w=Math.sin(S),L=Math.cos(S),T;S=parseFloat(g)*Mt,T=Math.cos(S),l=Gs(y,l,w*T*-v),o=Gs(y,o,-Math.sin(S)*-v),a=Gs(y,a,L*T*-v+v)}f!==Nt&&(b+="perspective("+f+ut),(n||r)&&(b+="translate("+n+"%, "+r+"%) "),(x||l!==Nt||o!==Nt||a!==Nt)&&(b+=a!==Nt||x?"translate3d("+l+", "+o+", "+a+") ":"translate("+l+", "+o+ut),d!==dt&&(b+="rotate("+d+ut),c!==dt&&(b+="rotateY("+c+ut),g!==dt&&(b+="rotateX("+g+ut),(h!==dt||m!==dt)&&(b+="skew("+h+", "+m+ut),(_!==1||u!==1)&&(b+="scale("+_+", "+u+ut),y.style[le]=b||"translate(0, 0)"},ao=function(e,t){var i=t||this,n=i.xPercent,r=i.yPercent,l=i.x,o=i.y,a=i.rotation,d=i.skewX,c=i.skewY,g=i.scaleX,h=i.scaleY,m=i.target,_=i.xOrigin,u=i.yOrigin,f=i.xOffset,p=i.yOffset,y=i.forceCSS,v=parseFloat(l),b=parseFloat(o),x,S,w,L,T;a=parseFloat(a),d=parseFloat(d),c=parseFloat(c),c&&(c=parseFloat(c),d+=c,a+=c),a||d?(a*=Mt,d*=Mt,x=Math.cos(a)*g,S=Math.sin(a)*g,w=Math.sin(a-d)*-h,L=Math.cos(a-d)*h,d&&(c*=Mt,T=Math.tan(d-c),T=Math.sqrt(1+T*T),w*=T,L*=T,c&&(T=Math.tan(c),T=Math.sqrt(1+T*T),x*=T,S*=T)),x=ce(x),S=ce(S),w=ce(w),L=ce(L)):(x=g,L=h,S=w=0),(v&&!~(l+"").indexOf("px")||b&&!~(o+"").indexOf("px"))&&(v=ot(m,"x",l,"px"),b=ot(m,"y",o,"px")),(_||u||f||p)&&(v=ce(v+_-(_*x+u*w)+f),b=ce(b+u-(_*S+u*L)+p)),(n||r)&&(T=m.getBBox(),v=ce(v+n/100*T.width),b=ce(b+r/100*T.height)),T="matrix("+x+","+S+","+w+","+L+","+v+","+b+")",m.setAttribute("transform",T),y&&(m.style[le]=T)},co=function(e,t,i,n,r){var l=360,o=_e(r),a=parseFloat(r)*(o&&~r.indexOf("rad")?ht:1),d=a-n,c=n+d+"deg",g,h;return o&&(g=r.split("_")[1],g==="short"&&(d%=l,d!==d%(l/2)&&(d+=d<0?l:-l)),g==="cw"&&d<0?d=(d+l*Xi)%l-~~(d/l)*l:g==="ccw"&&d>0&&(d=(d-l*Xi)%l-~~(d/l)*l)),e._pt=h=new Te(e._pt,t,i,n,d,zl),h.e=c,h.u="deg",e._props.push(i),h},ln=function(e,t){for(var i in t)e[i]=t[i];return e},uo=function(e,t,i){var n=ln({},i._gsap),r="perspective,force3D,transformOrigin,svgOrigin",l=i.style,o,a,d,c,g,h,m,_;n.svg?(d=i.getAttribute("transform"),i.setAttribute("transform",""),l[le]=t,o=Xt(i,1),lt(i,le),i.setAttribute("transform",d)):(d=getComputedStyle(i)[le],l[le]=t,o=Xt(i,1),l[le]=d);for(a in Qe)d=n[a],c=o[a],d!==c&&r.indexOf(a)<0&&(m=me(d),_=me(c),g=m!==_?ot(i,a,d,_):parseFloat(d),h=parseFloat(c),e._pt=new Te(e._pt,o,a,g,h-g,hi),e._pt.u=_||0,e._props.push(a));ln(o,n)};ke("padding,margin,Width,Radius",function(s,e){var t="Top",i="Right",n="Bottom",r="Left",l=(e<3?[t,i,n,r]:[t+r,t+i,n+i,n+r]).map(function(o){return e<2?s+o:"border"+o+s});Ts[e>1?"border"+s:s]=function(o,a,d,c,g){var h,m;if(arguments.length<4)return h=l.map(function(_){return Ye(o,_,d)}),m=h.join(" "),m.split(h[0]).length===5?h[0]:m;h=(c+"").split(" "),m={},l.forEach(function(_,u){return m[_]=h[u]=h[u]||h[(u-1)/2|0]}),o.init(a,m,g)}});var Pr={name:"css",register:pi,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,i,n,r){var l=this._props,o=e.style,a=i.vars.startAt,d,c,g,h,m,_,u,f,p,y,v,b,x,S,w,L,T;Oi||pi(),this.styles=this.styles||Tr(e),L=this.styles.props,this.tween=i;for(u in t)if(u!=="autoRound"&&(c=t[u],!(Me[u]&&fr(u,t,i,n,e,r)))){if(m=typeof c,_=Ts[u],m==="function"&&(c=c.call(i,n,e,r),m=typeof c),m==="string"&&~c.indexOf("random(")&&(c=Ut(c)),_)_(this,e,u,c,i)&&(w=1);else if(u.substr(0,2)==="--")d=(getComputedStyle(e).getPropertyValue(u)+"").trim(),c+="",nt.lastIndex=0,nt.test(d)||(f=me(d),p=me(c),p?f!==p&&(d=ot(e,u,d,p)+p):f&&(c+=f)),this.add(o,"setProperty",d,c,n,r,0,0,u),l.push(u),L.push(u,0,o[u]);else if(m!=="undefined"){if(a&&u in a?(d=typeof a[u]=="function"?a[u].call(i,n,e,r):a[u],_e(d)&&~d.indexOf("random(")&&(d=Ut(d)),me(d+"")||d==="auto"||(d+=$e.units[u]||me(Ye(e,u))||""),(d+"").charAt(1)==="="&&(d=Ye(e,u))):d=Ye(e,u),h=parseFloat(d),y=m==="string"&&c.charAt(1)==="="&&c.substr(0,2),y&&(c=c.substr(2)),g=parseFloat(c),u in je&&(u==="autoAlpha"&&(h===1&&Ye(e,"visibility")==="hidden"&&g&&(h=0),L.push("visibility",0,o.visibility),st(this,o,"visibility",h?"inherit":"hidden",g?"inherit":"hidden",!g)),u!=="scale"&&u!=="transform"&&(u=je[u],~u.indexOf(",")&&(u=u.split(",")[0]))),v=u in Qe,v){if(this.styles.save(u),T=c,m==="string"&&c.substring(0,6)==="var(--"){if(c=Pe(e,c.substring(4,c.indexOf(")"))),c.substring(0,5)==="calc("){var C=e.style.perspective;e.style.perspective=c,c=Pe(e,"perspective"),C?e.style.perspective=C:lt(e,"perspective")}g=parseFloat(c)}if(b||(x=e._gsap,x.renderTransform&&!t.parseTransform||Xt(e,t.parseTransform),S=t.smoothOrigin!==!1&&x.smooth,b=this._pt=new Te(this._pt,o,le,0,1,x.renderTransform,x,0,-1),b.dep=1),u==="scale")this._pt=new Te(this._pt,x,"scaleY",x.scaleY,(y?Lt(x.scaleY,y+g):g)-x.scaleY||0,hi),this._pt.u=0,l.push("scaleY",u),u+="X";else if(u==="transformOrigin"){L.push(Se,0,o[Se]),c=ro(c),x.svg?_i(e,c,0,S,0,this):(p=parseFloat(c.split(" ")[2])||0,p!==x.zOrigin&&st(this,x,"zOrigin",x.zOrigin,p),st(this,o,u,Ss(d),Ss(c)));continue}else if(u==="svgOrigin"){_i(e,c,1,S,0,this);continue}else if(u in Mr){co(this,x,u,h,y?Lt(h,y+c):c);continue}else if(u==="smoothOrigin"){st(this,x,"smooth",x.smooth,c);continue}else if(u==="force3D"){x[u]=c;continue}else if(u==="transform"){uo(this,c,e);continue}}else u in o||(u=Ot(u)||u);if(v||(g||g===0)&&(h||h===0)&&!jl.test(c)&&u in o)f=(d+"").substr((h+"").length),g||(g=0),p=me(c)||(u in $e.units?$e.units[u]:f),f!==p&&(h=ot(e,u,d,p)),this._pt=new Te(this._pt,v?x:o,u,h,(y?Lt(h,y+g):g)-h,!v&&(p==="px"||u==="zIndex")&&t.autoRound!==!1?Ul:hi),this._pt.u=p||0,v&&T!==c?(this._pt.b=d,this._pt.e=T,this._pt.r=Yl):f!==p&&p!=="%"&&(this._pt.b=d,this._pt.r=Vl);else if(u in o)no.call(this,e,u,d,y?y+c:c);else if(u in e)this.add(e,u,d||e[u],y?y+c:c,n,r);else if(u!=="parseTransform"){Ti(u,c);continue}v||(u in o?L.push(u,0,o[u]):typeof e[u]=="function"?L.push(u,2,e[u]()):L.push(u,1,d||e[u])),l.push(u)}}w&&gr(this)},render:function(e,t){if(t.tween._time||!Ni())for(var i=t._pt;i;)i.r(e,i.d),i=i._next;else t.styles.revert()},get:Ye,aliases:je,getSetter:function(e,t,i){var n=je[t];return n&&n.indexOf(",")<0&&(t=n),t in Qe&&t!==Se&&(e._gsap.x||Ye(e,"x"))?i&&Zi===i?t==="scale"?Xl:Zl:(Zi=i||{})&&(t==="scale"?Jl:eo):e.style&&!xi(e.style[t])?Ql:~t.indexOf("-")?Kl:$i(e,t)},core:{_removeProperty:lt,_getMatrix:Ii}};Le.utils.checkPrefix=Ot;Le.core.getStyleSaver=Tr;(function(s,e,t,i){var n=ke(s+","+e+","+t,function(r){Qe[r]=1});ke(e,function(r){$e.units[r]="deg",Mr[r]=1}),je[n[13]]=s+","+e,ke(i,function(r){var l=r.split(":");je[l[1]]=n[l[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ke("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){$e.units[s]="px"});Le.registerPlugin(Pr);var N=Le.registerPlugin(Pr)||Le;N.core.Tween;const on="level10-v19-style";function ho(){if(document.getElementById(on))return;const s=document.createElement("style");s.id=on,s.textContent=`
  ...
  `,document.head.appendChild(s)}const fo=["C5","D5","E5","F5","G5","A5","B5"],an=[{id:"do",solfege:"Do",low:"C4",high:"C5"},{id:"re",solfege:"Re",low:"D4",high:"D5"},{id:"mi",solfege:"Mi",low:"E4",high:"E5"},{id:"fa",solfege:"Fa",low:"F4",high:"F5"},{id:"sol",solfege:"Sol",low:"G4",high:"G5"},{id:"la",solfege:"La",low:"A4",high:"A5"},{id:"si",solfege:"Si",low:"B4",high:"B5"}];function po(s,e){const t=s.audio._webAudio;if(!t||!s.audio.unlocked)return;const i=s.audio._masterGain;if(!i)return;const r={C5:523.25,D5:587.33,E5:659.25,F5:698.46,G5:783.99,A5:880,B5:987.77}[e];if(!r)return;const l=t.currentTime,o=t.createOscillator();o.type="triangle",o.frequency.setValueAtTime(r,l);const a=t.createOscillator();a.type="sine",a.frequency.setValueAtTime(r*2,l);const d=t.createOscillator();d.type="sine",d.frequency.setValueAtTime(r*3,l);const c=t.createGain();c.gain.setValueAtTime(1e-4,l),c.gain.exponentialRampToValueAtTime(.55,l+.01),c.gain.exponentialRampToValueAtTime(1e-4,l+.8);const g=t.createGain();g.gain.value=.15;const h=t.createGain();h.gain.value=.05,o.connect(c).connect(i),a.connect(g).connect(c),d.connect(h).connect(c);const m=l+.85;o.start(l),o.stop(m),a.start(l),a.stop(m),d.start(l),d.stop(m)}function _o(s,e){try{s.audio.playNote(e)}catch{}}function is(s,e,t){t?po(s,e):_o(s,e)}function cn(s,e,t){const n={C4:{white:["C4","D4","E4","F4","G4","A4","B4"],black:[["C#4",0],["D#4",1],["F#4",3],["G#4",4],["A#4",5]]},C5:{white:["C5","D5","E5","F5","G5","A5","B5"],black:[["C#5",0],["D#5",1],["F#5",3],["G#5",4],["A#5",5]]}}[e],r=38,l=130,o=24,a=80,d=n.white.length*r,c=document.createElementNS(de,"svg");return c.setAttribute("viewBox",`0 0 ${d} ${l+8}`),c.setAttribute("preserveAspectRatio","xMidYMid meet"),c.classList.add("level10-keys-svg"),n.white.forEach((g,h)=>{const m=h*r,_=document.createElementNS(de,"rect");if(_.setAttribute("x",m),_.setAttribute("y",0),_.setAttribute("width",r-1),_.setAttribute("height",l),_.setAttribute("rx",4),_.setAttribute("class","level10-white-key"),_.setAttribute("data-pitch",g),_.setAttribute("fill","#fffaf0"),_.setAttribute("stroke",t),_.setAttribute("stroke-width","1.5"),c.appendChild(_),n.black.some(([u,f])=>f===h)){const u=m+r-o/2,f=document.createElementNS(de,"rect");f.setAttribute("x",u),f.setAttribute("y",0),f.setAttribute("width",o),f.setAttribute("height",a),f.setAttribute("rx",3),f.setAttribute("class","level10-black-key"),f.setAttribute("fill","#1a1a2a"),c.appendChild(f)}}),s.appendChild(c),c}function vo(s){ho(),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=10);const e=document.getElementById("hud-level2");e&&(e.style.display="none");const t=document.querySelector(".hud__dots");t&&(t.style.display="");const i=document.getElementById("btn-replay");i&&(i.style.display=""),s.scene=new zr(s.stage),s.stage.insertAdjacentHTML("beforeend",'<div class="level10-stage"></div>');const n=s.stage.querySelector(".level10-stage"),r=document.createElement("div");r.className="level10-hud",r.innerHTML=`
  ...
  `,n.appendChild(r);const l=document.createElement("div");l.className="level11-time-bar",l.innerHTML='<div class="level11-time-bar__fill" id="level11-time-fill"></div>',n.appendChild(l);const o=l.querySelector("#level11-time-fill"),a=document.createElement("div");a.className="level11-board",n.appendChild(a);const d=[];bo.forEach(f=>{d.push({...f,key:f.id+"_a"}),d.push({...f,key:f.id+"_b"})}),ko(d).forEach(f=>{const p=document.createElement("button");p.className="level11-card",p.dataset.key=f.key,p.dataset.id=f.id,p.dataset.pitch=f.pitch,p.dataset.color=f.color,p.innerHTML=`
    ...
    `,a.appendChild(p),d.push({el:p,...f})}),s._level11Cards=d,s._level11Flipped=[],s._level11Matched=0,s._level11Locked=!1,s._level11Start=Date.now(),s._level11Tried=0,s._level11Timer=null;const g=r.querySelector(".level11-time"),h=25,m=40;s._level11Timer=setInterval(()=>{if(!s._level11Start)return;const f=(Date.now()-s._level11Start)/1e3;if(g.textContent=f.toFixed(1),o){const p=Math.min(1,f/m);o.style.width=`${p*100}%`,o.classList.remove("warn","danger"),f>=m?o.classList.add("danger"):f>=h&&o.classList.add("warn")}},100);function _(f){if(!s._level11Locked&&!s._level11Flipped.includes(f)&&!f.classList.contains("matched")){f.classList.add("flipped"),s._level11Flipped.push(f);try{s.audio.playNote(f.dataset.pitch)}catch{}if(s._level11Flipped.length===2){s._level11Tried++,s._level11Locked=!0;const[p,y]=s._level11Flipped;p.dataset.id===y.dataset.id?setTimeout(()=>{p.classList.add("matched"),y.classList.add("matched");try{s.audio.correct()}catch{}try{xo(s.audio)}catch{}try{s._flashScreen()}catch{}s._level11Matched++,r.querySelector(".level11-done").textContent=String(s._level11Matched),s.say(`配对! ${p.dataset.id.toUpperCase()} = ${p.dataset.id.toUpperCase()} 🎉`);try{const v=p.getBoundingClientRect();s._floatScore(v.left+v.width/2,v.top,`${p.dataset.id.toUpperCase()} ✓`)}catch{}try{const v=p.getBoundingClientRect(),b=y.getBoundingClientRect(),x=(v.left+v.width/2+b.left+b.width/2)/2,S=(v.top+v.height/2+b.top+b.height/2)/2,w=n.querySelector(".level11-board"),L=w.getBoundingClientRect(),T=p.dataset.color||"#ffd166";wo(w,x-L.left,S-L.top,T)}catch{}setTimeout(()=>{s._level11Flipped=[],s._level11Locked=!1,s._level11Matched>=4&&u()},600)},350):setTimeout(()=>{try{s.audio.wrong()}catch{}p.classList.add("shake"),y.classList.add("shake"),setTimeout(()=>{p.classList.remove("flipped","shake"),y.classList.remove("flipped","shake"),s._level11Flipped=[],s._level11Locked=!1},450)},750)}}}s._level11Cards.forEach(f=>{f.el.addEventListener("click",()=>_(f.el))}),s.say("翻开两张牌 — 一样的就配对! 4 对就赢~"),s._level11Cards.forEach((f,p)=>{N.fromTo(f.el,{y:30,opacity:0},{y:0,opacity:1,duration:.4,delay:p*.05,ease:"back.out(1.7)"})});function u(){s._level11Timer&&(clearInterval(s._level11Timer),s._level11Timer=null);const f=(Date.now()-s._level11Start)/1e3,p=s._level11Tried;let y;f<=18&&p<=5?y=3:f<=30&&p<=7?y=2:f<=50?y=1:y=0;try{s.progress.markLevelComplete(11,y)}catch{}try{s.audio.playScale(["C4","E4","G4","C5"])}catch{}try{s._flashScreen()}catch{}try{s._floatScore(window.innerWidth/2,window.innerHeight*.45,`🎉 ${f.toFixed(1)}s 完成!`)}catch{}s.say(`🎉 用时 ${f.toFixed(1)}s, 翻 ${p} 次, 你真厉害!`),setTimeout(()=>{try{s.showWinOverlay(y,11)}catch{}},1300)}return()=>{if(s._level11Timer&&(clearInterval(s._level11Timer),s._level11Timer=null),s.scene){try{s.scene.teardown()}catch{}s.scene=null}s.stage&&s.stage.querySelectorAll(".level11-stage").forEach(f=>f.remove()),e&&(e.style.display=""),t&&(t.style.display=""),i&&(i.style.display=""),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const So=Object.freeze(Object.defineProperty({__proto__:null,default:To},Symbol.toStringTag,{value:"Module"}));class Lo{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level12-background";let t="";const i=["🍅","🧅","🥕","🥒","🌽","🍅","🧄"];for(let r=0;r<10;r++){const l=Math.random()*100,o=Math.random()*100,a=22+Math.random()*22,d=Math.random()*5,c=i[r%i.length];t+=`<g class="level12-veggie" transform="translate(${l}%, ${o}%) scale(${a/30})"
  ...
  `,n.appendChild(r);const l=r.querySelector(".level13-hits"),o=r.querySelector(".level13-misses"),a=r.querySelector(".level13-bpm"),d=s.stage.querySelector(".level13-metronome"),c=s.stage.querySelector('[data-l13-drum="shadow"]');let g=80,h=0,m=0,_=0,u=!1;const f=Date.now();let p=Date.now()+1e3;function y(){const L=Date.now()-f;if(L>15e3){const C=Math.min((L-15e3)/1e4,1);return Math.round(130+C*50)}if(L>8e3){const C=Math.min((L-8e3)/7e3,1);return Math.round(100+C*30)}const T=Math.min(L/8e3,1);return Math.round(80+T*20)}function v(){if(u)return;g=y(),a.textContent=String(g);const L=s.stage.querySelector("#bpm-count");L&&(L.textContent=String(g)),d&&(d.style.transition="transform 0.08s linear",d.style.transform="rotate(-25deg)",setTimeout(()=>{d&&(d.style.transform="rotate(25deg)")},100),setTimeout(()=>{d&&(d.style.transform="rotate(0)")},200));const T=6e4/g;p=Date.now()+T,setTimeout(v,T)}setTimeout(v,1e3);function b(){if(u)return;const L=Date.now(),T=Math.abs(L-p),C=6e4/g/3,E=C*2;if(T<C){h++,_++;try{s.audio.playNote("C4")}catch{}try{s.audio.correct()}catch{}c&&c.parentNode&&N.fromTo(c,{scale:1},{scale:.95,duration:.05,yoyo:!0,repeat:1,transformOrigin:"400px 380px"});try{s._floatScore(window.innerWidth/2,window.innerHeight*.45,"+1 完美 ⭐")}catch{}}else if(T<E){h++;try{s.audio.playNote("G4")}catch{}try{s._floatScore(window.innerWidth/2,window.innerHeight*.45,"+1 ✨")}catch{}}else{m++;try{s.audio.wrong()}catch{}try{s._floatScore(window.innerWidth/2,window.innerHeight*.45,"漏拍 ✗")}catch{}}l.textContent=String(h),o.textContent=String(m),h+m>=30&&(u=!0,setTimeout(()=>w(),600))}c&&c.parentNode&&(c.style.cursor="pointer",c.style.pointerEvents="all",c.addEventListener("pointerdown",L=>{L.preventDefault(),L.stopPropagation(),b()}));const x=document.createElement("div");x.className="level13-tap-zone",x.addEventListener("pointerdown",L=>{L.preventDefault(),b()}),s.stage.appendChild(x);const S=L=>{u||(L.code==="Space"||L.key===" ")&&(L.preventDefault(),b())};window.addEventListener("keydown",S),s.say("跟着拍子敲鼓! 速度会逐渐变快 — 完美一击拿星 ⭐");function w(){u=!0;let L;_>=30?L=3:_>=24?L=2:_>=18?L=1:L=0;try{s.progress.markLevelComplete(13,L)}catch{}try{s.audio.playScale(["C4","E4","G4","C5"])}catch{}try{s._flashScreen()}catch{}const T=h+m,C=T>0?Math.round(h/T*100):0;try{s._floatScore(window.innerWidth/2,window.innerHeight*.4,`🎵 完美 ${_} 次 (命中 ${C}%)`)}catch{}s.say(`完美 ${_} 次 — 你是节奏大师! 🎵`),setTimeout(()=>{try{s.showWinOverlay(L,13)}catch{}},1300)}return()=>{if(u=!0,window.removeEventListener("keydown",S),s.scene){try{s.scene.teardown()}catch{}s.scene=null}s.stage&&(s.stage.querySelectorAll(".level13-stage").forEach(L=>L.remove()),s.stage.querySelectorAll(".level13-tap-zone").forEach(L=>L.remove())),e&&(e.style.display=""),t&&(t.style.display=""),i&&(i.style.display=""),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const Oo=Object.freeze(Object.defineProperty({__proto__:null,default:Do},Symbol.toStringTag,{value:"Module"}));class No{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level14-background";let t="";for(let n=0;n<50;n++){const r=Math.random()*100,l=Math.random()*100,o=1+Math.random()*2.5,a=Math.random()*4;t+=`<circle class="level14-star" cx="${r}%" cy="${l}%" r="${o}"
  ...
  `,r.appendChild(d);const c=d.querySelector(".level14-card__name"),g=d.querySelector(".level14-card__solfege"),h=d.querySelectorAll(".level14-slot");s.kb=new gt(s.stage,Ws),s._level14Idx=0,s._level14Perfect=0,s._level14Step=0,s._level14Done=!1,s._level14Failed=!1;function m(p){const y=js[p];c.textContent=y.name,c.style.background=`linear-gradient(135deg, ${y.color}, #fff8dc)`,c.style.webkitBackgroundClip="text",c.style.backgroundClip="text",c.style.color="transparent",g.textContent=y.solfege,h.forEach((v,b)=>{v.classList.remove("lit","placed","incorrect"),v.textContent=b===0?"🐟":"❓"})}function _(){s._level14Step=0,s._level14Failed=!1,h.forEach((p,y)=>{p.classList.remove("lit","placed","incorrect"),p.textContent=y===0?"🐟":"❓"})}function u(p,y,v){h[p].textContent=y,h[p].classList.add(v),setTimeout(()=>h[p].classList.remove(v),350)}s.kb.onPress=p=>{if(s._level14Done)return;const y=js[s._level14Idx],v=y.ids[s._level14Step],b=p.dataset.id,x=Ws.find(S=>S.id===b);try{s.kb.glowKey(p)}catch{}if(b===v){try{s.audio.correct()}catch{}try{s.audio.playNote(x.pitch)}catch{}if(s._level14Step===0)u(0,x.solfege,"placed"),h[0].style.color=y.color;else{u(s._level14Step,x.solfege,"placed"),h[s._level14Step].style.color=y.color;const S=s._level14Step+1;S<h.length&&(h[S].textContent="🐟")}if(s._level14Step++,s._level14Step>=3){s._level14Failed||(s._level14Perfect++,a.textContent=String(s._level14Perfect)),s._level14Idx++,o.textContent=String(s._level14Idx);try{s.audio.playScale(y.ids.map(S=>Ws.find(w=>w.id===S).pitch))}catch{}try{s._flashScreen()}catch{}try{s._floatScore(window.innerWidth/2,window.innerHeight*.36,"+1 ⭐")}catch{}s._level14Idx>=js.length?(s._level14Done=!0,setTimeout(()=>f(),700)):setTimeout(()=>{m(s._level14Idx),_()},800)}}else{try{s.audio.wrong()}catch{}try{s.audio.playNote(x.pitch)}catch{}s._level14Failed=!0,s.wrongCount++,h.forEach(S=>{S.classList.add("incorrect")}),s.say(`错啦 — 应该是 ${y.solfege.split(/-+/).map(S=>S.trim()).filter(Boolean).join(" → ")}, 再来一次~`),setTimeout(()=>{_()},700)}},m(0),_(),s.say("看和弦卡 — 三条小鱼的顺序! 按钢琴键组成和弦~");function f(){const p=s._level14Perfect;let y;p>=5?y=3:p>=4?y=2:p>=3?y=1:y=0;try{s.progress.markLevelComplete(14,y)}catch{}try{s.audio.playScale(["C4","E4","G4","C5"])}catch{}try{s._flashScreen()}catch{}try{s._floatScore(window.innerWidth/2,window.innerHeight*.42,`🎵 完美 ${p} / 5 和弦`)}catch{}s.say(`和弦大师! ${p} 个和弦完美完成 🎵`),setTimeout(()=>{try{s.showWinOverlay(y,14)}catch{}},1300)}return()=>{if(s.scene){try{s.scene.teardown()}catch{}s.scene=null}n&&n.parentNode&&n.remove(),s.stage&&s.stage.querySelectorAll(".level14-stage").forEach(p=>p.remove()),e&&(e.style.display=""),t&&(t.style.display=""),i&&(i.style.display=""),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const Ho=Object.freeze(Object.defineProperty({__proto__:null,default:qo},Symbol.toStringTag,{value:"Module"}));class Go{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level15-background";const t=`
  ...
  `),s.kb=new gt(s.stage,It);const a={value:1};s._level15Idx=0,s._level15Correct=0,s._level15Accepting=!0,s._level15Done=!1,s._level15ConsecRight=0,s._level15ConsecWrong=0,s._level15Easy=!1;function d(){return It[Math.floor(Math.random()*It.length)]}function c(y,v){a.value=y;const b=document.getElementById("level15-bpm");b&&(b.textContent=v||`${y.toFixed(1)}x`)}function g(){return Math.max(jo,Math.round(Wo/a.value))}function h(){if(s._level15Done||s._level15Idx>=os)return;const y=d(),v=zo[y.id];if(!l||!o)return;const b=r.querySelector(".level15-note-grp");if(!b)return;b.setAttribute("transform",`translate(400, ${v})`),l.dataset.pitch=y.pitch,l.dataset.id=y.id,l.classList.remove("incorrect"),l.style.opacity="1",l.setAttribute("fill","#ffd166"),s.say(`下一个: ${y.solfege}`),s._level15Accepting=!0;const x=g(),S=Date.now(),w=setTimeout(()=>{!s._level15Done&&s._level15Accepting&&m()},x);s._level15FallTimer=w,s._level15FallStart=S,s._level15FallDur=x}function m(){s._level15Accepting=!1,s.wrongCount++,s._level15ConsecWrong++,s._level15ConsecRight=0,_();try{s.audio.wrong()}catch{}s.say("漏拍啦 — 看下一个音符~"),l&&l.classList.add("incorrect"),s._level15FallTimer&&clearTimeout(s._level15FallTimer),setTimeout(()=>{l&&l.classList.remove("incorrect"),s._level15Idx++,s._level15Idx>=os?f():h()},500)}function _(){if(!s._level15Easy&&s._level15ConsecWrong>=3){s._level15Easy=!0,c(1,"1.0x 轻松");try{s.say("进入轻松模式 — 慢慢来!")}catch{}}}function u(){if(a.value>=1.5)return;const y=Math.min(1.5,+(a.value+.1).toFixed(1));c(y);const v=document.getElementById("level15-combo");v&&(v.textContent=`连对 ${s._level15ConsecRight} → 加速!`)}s.kb.onPress=y=>{if(!s._level15Accepting||s._level15Done)return;const v=y.dataset.pitch,b=y.dataset.id,x=l?l.dataset.pitch:null,S=l?l.dataset.id:null;try{s.kb.glowKey(y)}catch{}if(v===x){s._level15Accepting=!1,s._level15Correct++,s._level15ConsecRight++,s._level15ConsecWrong=0,s._level15FallTimer&&clearTimeout(s._level15FallTimer);try{s.audio.correct()}catch{}try{s.audio.playNote(v)}catch{}l&&(l.style.opacity="0");const w=["完美!","棒!","眼睛真快!","看谱高手!"];s.say(w[Math.min(s._level15Correct-1,w.length-1)]),s._level15ConsecRight>=3&&!s._level15Easy&&u(),s._level15Idx++,setTimeout(()=>{s._level15Idx>=os?f():h()},350)}else{s.wrongCount++,s._level15ConsecWrong++,s._level15ConsecRight=0,_();try{s.audio.wrong()}catch{}try{s.audio.playNote(v)}catch{}const w=It.find(T=>T.id===b);s.say(`这是 ${w?w.solfege:"?"}, 不是 ${It.find(T=>T.id===S).solfege}. 再看谱!`),l&&l.classList.add("incorrect");const L=l;setTimeout(()=>{L&&L.classList.remove("incorrect")},350)}};function f(){s._level15Done||(s._level15Done=!0,setTimeout(()=>p(),600))}c(1,"1.0x"),setTimeout(h,800),s.say("看 5 线谱上的音符 — 按对应的钢琴键, 越对越快!");function p(){const y=s._level15Correct;let v;y>=5?v=3:y>=4?v=2:y>=3?v=1:v=0;try{s.progress.markLevelComplete(15,v)}catch{}try{s.audio.playScale(["C4","E4","G4","C5"])}catch{}try{s._flashScreen()}catch{}try{s._floatScore(window.innerWidth/2,window.innerHeight*.42,`🎵 看谱对了 ${y} / ${os}`)}catch{}s.say(`视奏大师! 6 音对了 ${y} 个 🎼`),setTimeout(()=>{try{s.showWinOverlay(v,15)}catch{}},1300)}return()=>{if(s._level15FallTimer&&(clearTimeout(s._level15FallTimer),s._level15FallTimer=null),s.scene){try{s.scene.teardown()}catch{}s.scene=null}n&&n.parentNode&&n.remove(),s.stage&&(s.stage.querySelectorAll(".level15-staff-area").forEach(y=>y.remove()),s.stage.querySelectorAll(".level15-metronome").forEach(y=>y.remove())),e&&(e.style.display=""),t&&(t.style.display=""),i&&(i.style.display=""),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const Yo=Object.freeze(Object.defineProperty({__proto__:null,default:Vo},Symbol.toStringTag,{value:"Module"}));class Uo{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level16-background";let t="";for(let n=0;n<20;n++){const r=Math.random()*100,l=Math.random()*100,o=6+Math.random()*12,a=Math.random()*5,d=4+Math.random()*4;t+=`<circle class="level16-particle" cx="${r}%" cy="${l}%" r="${o}"
  ...
  `,n.appendChild(c);const g=c.querySelector("svg"),h=g?g.querySelector("[data-l16-drum-head]"):null,m=g?g.querySelector("text"):null,_=document.createElement("div");_.className="level16-meter",_.innerHTML=`
  ...
  `,n.appendChild(_);const u=document.createElement("div");u.className="level16-ladder";let f="";for(let T=0;T<as;T++){const C=cs+pn*T;f+=`
  ...
  `),e.insertAdjacentHTML("beforeend",`
    <div class="level2-progress-dots" id="level2-progress-dots">
      ${[1,2,3,4,5].map(y=>`<span class="level2-prog-dot" data-i="${y}"></span>`).join("")}
    </div>
  `);function t(){const y=e.querySelectorAll(".level2-prog-dot"),v=s._level2Done?s._level2Done.size:0;y.forEach((b,x)=>{x<v?b.classList.add("filled"):b.classList.remove("filled")})}function i(y){if(!y)return;const v=y.getBoundingClientRect(),b=e.getBoundingClientRect(),x=v.left-b.left+v.width/2,S=v.top-b.top,w=document.createElement("div");w.className="level2-correct-bubble",w.textContent="✨ 答对啦! ✨",w.style.left=x+"px",w.style.top=S-36+"px",e.appendChild(w),setTimeout(()=>w.remove(),1400);for(let L=0;L<6;L++){const T=document.createElement("div");T.className="level2-sparkle",T.style.left=x+(Math.random()-.5)*70+"px",T.style.top=S+(Math.random()-.5)*70+"px",T.style.animationDelay=L*.06+"s",e.appendChild(T),setTimeout(()=>T.remove(),1100)}}function n(y,v){const b=document.createElement("div");b.className="level2-big-solfege",v&&b.style.setProperty("--big-solfege-color",v),b.textContent=y,e.appendChild(b),e.classList.add("level2-bg-pulse"),setTimeout(()=>{e.classList.remove("level2-bg-pulse");try{b.remove()}catch{}},1500)}const r={Do:[130.81,261.63,392],Re:[146.83,293.66,440],Mi:[164.81,329.63,493.88],Fa:[174.61,349.23,523.25],Sol:[196,392,587.33],La:[220,440,659.25],Si:[246.94,493.88,739.99]};function l(y){const v=s.audio;if(!v||!v._webAudio||v.muted)return;const b=v._webAudio;try{v._resumeWebAudio&&v._resumeWebAudio()}catch{}const x=r[y]||r.Do,S=b.currentTime+.05;x.forEach((w,L)=>{const T=S+L*.13,C=b.createOscillator();C.type="triangle",C.frequency.setValueAtTime(w,T);const E=b.createGain();E.gain.setValueAtTime(1e-4,T),E.gain.exponentialRampToValueAtTime(.5,T+.02),E.gain.exponentialRampToValueAtTime(1e-4,T+.18),C.connect(E).connect(v._masterGain),C.start(T),C.stop(T+.22),typeof v._trackOsc=="function"&&v._trackOsc(C,T+.22)})}const o=s._markLevel2FishCorrect.bind(s);s._markLevel2FishCorrect=y=>{o(y),t(),i(y);const v=y&&y.dataset?y.dataset.id:null;if(v){const b=a.find(x=>x.id===v);if(b){n(b.solfege,b.color);try{l(b.solfege)}catch{}}}typeof f=="function"&&f()};const a=[{id:"do",pitch:"C4"},{id:"re",pitch:"D4"},{id:"mi",pitch:"E4"},{id:"fa",pitch:"F4"},{id:"sol",pitch:"G4"},{id:"la",pitch:"A4"},{id:"si",pitch:"B4"}],d={C4:261.63,D4:293.66,E4:329.63,F4:349.23,G4:392,A4:440,B4:493.88};function c(y){const v=s.audio;if(!v||!v._webAudio||!v._masterGain||v.muted)return!1;const b=v._webAudio;try{v._resumeWebAudio&&v._resumeWebAudio()}catch{}const x=b.currentTime,S=d[y];if(!S)return!1;const w=b.createOscillator();w.type="triangle",w.frequency.setValueAtTime(S,x);const L=b.createOscillator();L.type="sine",L.frequency.setValueAtTime(S*2,x);const T=b.createOscillator();T.type="sine",T.frequency.setValueAtTime(S*3,x);const C=b.createGain();C.gain.setValueAtTime(1e-4,x),C.gain.exponentialRampToValueAtTime(1,x+.015),C.gain.exponentialRampToValueAtTime(.7,x+.35),C.gain.exponentialRampToValueAtTime(1e-4,x+2.2);const E=b.createGain();E.gain.value=.18;const A=b.createGain();A.gain.value=.06,w.connect(C).connect(v._masterGain),L.connect(E).connect(C),T.connect(A).connect(C);const P=x+2.3;return w.start(x),w.stop(P),L.start(x),L.stop(P),T.start(x),T.stop(P),!0}const g=s._replayQuestion.bind(s);s._replayQuestion=()=>{const y=s.audio,v=s._level2AnswerNote;if(!v)return;const b=a.find(E=>E.id===v);if(!b){g();return}if(!y||!y._webAudio||!y._masterGain){g();return}const x=y._webAudio,S=y._masterGain,w=x.currentTime,L=y.muted?0:.75,T=y.muted?0:1;try{const E=typeof S.gain.value=="number"?S.gain.value:L;S.gain.cancelScheduledValues(w),S.gain.setValueAtTime(E,w),S.gain.linearRampToValueAtTime(T,w+.06),S.gain.linearRampToValueAtTime(L,w+2.5)}catch{}c(b.pitch);const C=document.getElementById("level2-listen-prompt");C&&(C.classList.add("active"),clearTimeout(C._hideTimer),C._hideTimer=setTimeout(()=>C.classList.remove("active"),2500))};function h(){[3,2,1].forEach((v,b)=>{setTimeout(()=>{const x=document.createElement("div");x.className="level2-countdown",x.textContent=String(v),e.appendChild(x),setTimeout(()=>{try{x.remove()}catch{}},720)},b*650)})}const m=s._level2NextQuestion.bind(s);s._level2NextQuestion=()=>{const y=!s._level2AnswerNote;m(),!y&&s._level2AnswerNote&&h()};let _=null;function u(){_&&clearTimeout(_),_=setTimeout(()=>{if(s._level2AnswerNote&&(s._level2Done||new Set).size<(s._level2Total||5))try{s.say("哪条小鱼刚才唱歌了? 点点它 🎵")}catch{}},1e4)}function f(){u()}const p=s._replayQuestion;if(s._replayQuestion=()=>{try{p()}catch{}f()},typeof s._handleLevel2Answer=="function"){const y=s._handleLevel2Answer.bind(s);s._handleLevel2Answer=(v,b)=>{try{y(v,b)}catch{}f()}}return setTimeout(f,1200),t(),()=>{_&&(clearTimeout(_),_=null),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null);const y=document.getElementById("hud-level2");y&&(y.style.display="");const v=document.querySelector(".hud__dots");v&&(v.style.display="none");const b=document.getElementById("btn-replay");b&&(b.style.display="none");const x=document.getElementById("level2-listen-prompt");x&&x.remove();const S=document.getElementById("level2-progress-dots");S&&S.remove(),e.querySelectorAll(".level2-correct-bubble, .level2-sparkle, .level2-countdown").forEach(w=>w.remove())}}const Jo=Object.freeze(Object.defineProperty({__proto__:null,default:Xo},Symbol.toStringTag,{value:"Module"}));class ea{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level3-background",e.innerHTML=`
      <svg viewBox="0 0 800 500" preserveAspectRatio="xMidYMid slice"
           xmlns="${de}">
        <!-- 太阳 (右上角) -->
  ...
  `,document.head.appendChild(s)}class Ls{constructor(e,t){aa(),this.stage=e,this.notes=t,this.fishes=[],this.onDrop=null,this.onDragStart=null,this.onDragMove=null,this.onTap=null,this._dragEnabled=!0,this._lastHoveredSlot=null,this.TAP_THRESHOLD=12,this._renderPool(),requestAnimationFrame(()=>this._placeFishes()),this._onResize=()=>{clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(()=>this._handleViewportChange(),150)},window.addEventListener("resize",this._onResize),window.addEventListener("orientationchange",this._onResize)}_clampFishesToPool(){if(!this.pool)return;const e=this.pool.getBoundingClientRect();if(e.width<2||e.height<2)return;const t=ds(e),i=t.padX,n=e.width-t.padX-t.slotW,r=e.height-t.slotH,l=Math.max(i,n),o=Math.max(0,r);this.fishes.forEach(a=>{if(a.locked||a.el.classList.contains("dragging"))return;const d=Math.min(Math.max(a.originalLeft,i),l),c=Math.min(Math.max(a.originalTop,0),o);d===a.originalLeft&&c===a.originalTop||(a.originalLeft=d,a.originalTop=c,a.el.style.transition="left 200ms ease-out, top 200ms ease-out",a.el.style.left=`${d}px`,a.el.style.top=`${c}px`,setTimeout(()=>{a.el.style.transition=""},220))})}destroy(){this._onResize&&(window.removeEventListener("resize",this._onResize),window.removeEventListener("orientationchange",this._onResize),this._onResize=null),clearTimeout(this._resizeTimer)}_handleViewportChange(){if(!this.pool)return;const e=this.pool.getBoundingClientRect();if(e.width<2||e.height<2)return;const t=this._lastPoolH||0;this._lastPoolW,this._lastPoolH=e.height,this._lastPoolW=e.width,t>0&&Math.abs(e.height-t)/Math.max(t,1)>.3&&this.fishes.some(n=>!n.locked)?this._redistributeUnlocked():this._clampFishesToPool()}_redistributeUnlocked(){const e=this.fishes.filter(c=>!c.locked&&!c.el.classList.contains("dragging"));if(!e.length)return;const t=this.pool.getBoundingClientRect(),i=ds(t);this._m=i;const n=[];this.fishes.forEach(c=>{if(c.locked||c.el.classList.contains("dragging")){const g=c.el.getBoundingClientRect(),h=this.pool.getBoundingClientRect();n.push({x:g.left+g.width/2-h.left,y:g.top+g.height/2-h.top})}});const r=Math.max(i.padX,i.slotW/2),l=t.width-i.padX-i.slotW/2,o=i.slotH/2-i.overY,a=t.height-i.slotH/2,d=i.minDist*i.minDist;e.forEach(c=>{let g=null,h=-1/0;for(let u=0;u<70;u++){const f=r+Math.random()*Math.max(1,l-r),p=o+Math.random()*Math.max(1,a-o);let y=1/0;for(const v of n){const b=v.x-f,x=v.y-p;y=Math.min(y,b*b+x*x)}if(y>=d){g={cx:f,cy:p};break}y>h&&(h=y,g={cx:f,cy:p})}if(!g)return;const m=Math.round(g.cx-i.slotW/2),_=Math.round(g.cy-i.slotH/2);c.originalLeft=m,c.originalTop=_,c.el.style.width=`${i.slotW}px`,c.el.style.height=`${i.slotH}px`,c.el.style.transition="left 260ms ease-out, top 260ms ease-out",c.el.style.left=`${m}px`,c.el.style.top=`${_}px`,setTimeout(()=>{c.el.style.transition=""},300),n.push({x:g.cx,y:g.cy})})}_renderPool(){const e=document.createElement("div");e.className="fish-pool",e.setAttribute("aria-label","小鱼池"),this.stage.appendChild(e),this.pool=e,this.root=e}_placeFishes(){const e=this.pool.getBoundingClientRect();if(e.width<2||e.height<2){requestAnimationFrame(()=>this._placeFishes());return}const t=[...this.notes];for(let m=t.length-1;m>0;m--){const _=Math.floor(Math.random()*(m+1));[t[m],t[_]]=[t[_],t[m]]}const i=ds(e);this._m=i;const n=i.padX,r=e.width-i.padX-i.slotW,l=-i.overY,o=e.height-i.slotH,a=i.minDist,d=a*a,c=90,g=[];function h(m,_){for(let u=0;u<g.length;u++){const f=g[u],p=f.x-m,y=f.y-_;if(p*p+y*y<d)return!1}return!0}t.forEach(m=>{const _=document.createElement("div");_.className="fish is-floating",_.dataset.id=m.id,_.dataset.color=m.color,_.dataset.solfege=m.solfege,_.dataset.pitch=m.pitch,_.style.webkitUserSelect="none",_.style.userSelect="none",_.style.webkitTapHighlightColor="transparent";const u=n+i.slotW/2,f=r-i.slotW/2,p=l+i.slotH/2,y=o-i.slotH/2,v=Math.max(1,f-u),b=Math.max(1,y-p);let x=0,S=0,w=!1;for(let R=0;R<c;R++){const G=u+Math.random()*v,Z=p+Math.random()*b;if(h(G,Z)){x=G,S=Z,w=!0;break}}if(!w){let R=-1/0,G=u,Z=p;for(let be=0;be<60;be++){const M=u+Math.random()*v,k=p+Math.random()*b;let D=1/0;for(let I=0;I<g.length;I++){const B=g[I],q=B.x-M,H=B.y-k,F=Math.sqrt(q*q+H*H);F<D&&(D=F)}D>R&&(R=D,G=M,Z=k)}x=G,S=Z}const L=x-i.slotW/2,T=S-i.slotH/2;_.style.left=`${L}px`,_.style.top=`${T}px`,_.style.width=`${i.slotW}px`,_.style.height=`${i.slotH}px`,g.push({x,y:S});const C=(Math.random()-.5)*6,E=3.5+Math.random()*1,A=-Math.random()*E;_.style.setProperty("--fish-float-dur",`${E.toFixed(2)}s`),_.style.setProperty("--fish-float-delay",`${A.toFixed(2)}s`);const P=document.createElement("div");P.className="fish-inner",P.style.setProperty("--fish-rot",`${C.toFixed(2)}deg`);let $=null;try{const R=new na(m);R&&R.nodeType===1?$=R:$=R?.root||R?.element||R?.svg||null}catch(R){console.warn("[FishPool] Fish creation failed (Agent A 还没就绪?):",R)}$&&$.nodeType===1?P.appendChild($):P.innerHTML=`
          <div style="
          ...
          ">${m.solfege}</div>
        `,_.appendChild(P),this.pool.appendChild(_);const O={el:_,inner:P,note:m,originalLeft:L,originalTop:T,rot:C,locked:!1};this.fishes.push(O),this._bindDrag(O)})}_bindDrag(e){const t=e.el;let i=null,n=0,r=0,l=0,o=0,a=0;const d=h=>{if(e.locked)return;const m=Date.now();if(m-(this._lastTapTime||0)<250&&this._lastTapEl===t||(this._lastTapTime=m,this._lastTapEl=t,this._dragEnabled===!1)||i!==null||h.pointerType==="mouse"&&h.button!==0)return;try{t.setPointerCapture(h.pointerId)}catch{}i=h.pointerId;const _=t.getBoundingClientRect();if(n=h.clientX-_.left,r=h.clientY-_.top,l=h.clientX,o=h.clientY,a=0,t.classList.add("dragging"),t.classList.add("pressing"),e.el.style.animationPlayState="paused",t.style.position="fixed",t.style.left=`${h.clientX-n}px`,t.style.top=`${h.clientY-r}px`,t.style.right="auto",t.style.bottom="auto",t.style.margin="0",t.style.transform="",typeof this.onDragStart=="function")try{this.onDragStart(t)}catch(u){console.warn(u)}},c=h=>{if(i!==h.pointerId)return;h.preventDefault(),t.style.left=`${h.clientX-n}px`,t.style.top=`${h.clientY-r}px`;const m=h.clientX-l,_=h.clientY-o,u=Math.hypot(m,_);if(a=Math.max(a,u),a>this.TAP_THRESHOLD&&t.classList.contains("pressing")&&t.classList.remove("pressing"),typeof this.onDragMove=="function"){const f=document.querySelectorAll(".staff-slot");let p=null,y=1/0;if(f.forEach(v=>{const b=v.getBoundingClientRect(),x=b.left+b.width/2,S=b.top+b.height/2,w=Math.hypot(x-h.clientX,S-h.clientY);w<y&&(y=w,p=v)}),p!==this._lastHoveredSlot){this._lastHoveredSlot=p;try{this.onDragMove(t,p)}catch(v){console.warn(v)}}}},g=h=>{if(i!==h.pointerId)return;i=null;try{t.releasePointerCapture(h.pointerId)}catch{}if(a<this.TAP_THRESHOLD){if(t.classList.remove("dragging"),t.classList.remove("pressing"),t.style.position="",t.style.left=`${e.originalLeft}px`,t.style.top=`${e.originalTop}px`,t.style.right="",t.style.bottom="",t.style.margin="",t.style.transform="",e.el.style.animationPlayState="",typeof this.onDragMove=="function"){this._lastHoveredSlot=null;try{this.onDragMove(t,null)}catch(b){console.warn(b)}}if(typeof this.onTap=="function")try{this.onTap(t)}catch(b){console.warn(b)}return}const m=document.querySelectorAll(".staff-slot");let _=null,u=1/0;const f=t.getBoundingClientRect(),p=f.left+f.width/2,y=f.top+f.height/2;m.forEach(b=>{const x=b.getBoundingClientRect(),S=x.left+x.width/2,w=x.top+x.height/2,L=Math.hypot(S-p,w-y);L<u&&(u=L,_=b)});const v=!!_&&u<ra&&_.dataset.id===e.note.id;if(t.classList.remove("dragging"),t.classList.remove("pressing"),t.style.position="",t.style.left=`${e.originalLeft}px`,t.style.top=`${e.originalTop}px`,t.style.right="",t.style.bottom="",t.style.margin="",t.style.transform="",e.el.style.animationPlayState="",typeof this.onDragMove=="function"){this._lastHoveredSlot=null;try{this.onDragMove(t,null)}catch(b){console.warn(b)}}if(v&&this._spawnSourceShadow(e),typeof this.onDrop=="function")try{this.onDrop(t,_,v)}catch(b){console.warn(b)}};t.addEventListener("pointerdown",d),t.addEventListener("pointermove",c),t.addEventListener("pointerup",g),t.addEventListener("pointercancel",g),t.addEventListener("click",h=>{if(e.locked)return;const m=Date.now();if(!(m-(this._lastTapTime||0)<250&&this._lastTapEl===t)&&(this._lastTapTime=m,this._lastTapEl=t,typeof this.onTap=="function"))try{this.onTap(t)}catch(_){console.warn(_)}})}lockFish(e){const t=this.fishes.find(i=>i.note.id===e);t&&(t.locked=!0,t.el.classList.add("fish--locked"))}_spawnSourceShadow(e){if(!this.pool)return;const t=document.createElement("div");t.className="fish-source-shadow";const i=e.note&&e.note.color?e.note.color:"rgba(20,40,70,0.45)";t.style.setProperty("--shadow-color",i);const n=e.el.offsetWidth||(this._m?this._m.slotW:$r),r=e.el.offsetHeight||(this._m?this._m.slotH:vi);t.style.left=`${e.originalLeft+n/2}px`,t.style.top=`${e.originalTop+r/2}px`,this.pool.appendChild(t),setTimeout(()=>{try{t.remove()}catch{}},1400)}setDragEnabled(e){this._dragEnabled=e!==!1}unlockAll(){this.fishes.forEach(e=>{e.locked=!1,e.el.classList.remove("fish--locked"),e.el.classList.remove("dragging","shake"),e.el.style.position="",e.el.style.left=`${e.originalLeft}px`,e.el.style.top=`${e.originalTop}px`,e.el.style.right="",e.el.style.bottom="",e.el.style.margin="",e.el.style.transform="",e.el.style.animationPlayState=""})}intro(){const e=()=>{if(this.fishes.length<this.notes.length){requestAnimationFrame(e);return}this.fishes.forEach((t,i)=>{N.fromTo(t.el,{y:140,opacity:0,scale:.4},{y:0,opacity:1,scale:1,duration:.6,delay:i*.08,ease:"back.out(1.7)"})})};e()}reset(){if(!this.pool)return;const e=this.pool.getBoundingClientRect();if(e.width>=2&&e.height>=2){const t=ds(e);this._m=t;const i=t.padX,n=e.width-t.padX-t.slotW,r=-t.overY,l=e.height-t.slotH,o=t.minDist,a=o*o,d=90,c=[],g=(h,m)=>{for(let _=0;_<c.length;_++){const u=c[_],f=u.x-h,p=u.y-m;if(f*f+p*p<a)return!1}return!0};this.fishes.forEach(h=>{const m=i+t.slotW/2,_=n-t.slotW/2,u=r+t.slotH/2,f=l-t.slotH/2,p=Math.max(1,_-m),y=Math.max(1,f-u);let v=0,b=0,x=!1;for(let S=0;S<d;S++){const w=m+Math.random()*p,L=u+Math.random()*y;if(g(w,L)){v=w,b=L,x=!0;break}}if(!x){let S=-1/0,w=m,L=u;for(let T=0;T<60;T++){const C=m+Math.random()*p,E=u+Math.random()*y;let A=1/0;for(let P=0;P<c.length;P++){const $=c[P],O=$.x-C,R=$.y-E,G=Math.sqrt(O*O+R*R);G<A&&(A=G)}A>S&&(S=A,w=C,L=E)}v=w,b=L}h.originalLeft=v-t.slotW/2,h.originalTop=b-t.slotH/2,h.el.style.width=`${t.slotW}px`,h.el.style.height=`${t.slotH}px`,c.push({x:v,y:b})})}this.unlockAll(),this.fishes.forEach(t=>{N.fromTo(t.el,{y:60,opacity:.6,scale:.85},{y:0,opacity:1,scale:1,duration:.5,ease:"back.out(1.4)",delay:Math.random()*.15})})}getFishes(){return this.fishes.map(e=>e.el)}}const zs=[{id:"do",solfege:"Do",pitch:"C4",note:"C",color:"#e63946"},{id:"re",solfege:"Re",pitch:"D4",note:"D",color:"#f4a261"},{id:"mi",solfege:"Mi",pitch:"E4",note:"E",color:"#ffc971"},{id:"fa",solfege:"Fa",pitch:"F4",note:"F",color:"#b5c99a"},{id:"sol",solfege:"Sol",pitch:"G4",note:"G",color:"#457b9d"},{id:"la",solfege:"La",pitch:"A4",note:"A",color:"#6a4c93"},{id:"si",solfege:"Si",pitch:"B4",note:"B",color:"#9b5de5"}],gn=new Set(["do","mi","sol"]),ca=130,da=["真棒!","太厉害了~","不错哟!"];function ua(s){typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=3);const e=document.getElementById("hud-level2");e&&(e.style.display="none");const t=document.querySelector(".hud__dots");t&&(t.style.display="");const i=document.getElementById("btn-replay");i&&(i.style.display=""),s.scene=new ea(s.stage),s.fishPool=new Ls(s.stage,zs),s.fishPool.setDragEnabled(!0),s.fishPool.intro(),s.say("柯尔文爷爷想听 Do Mi Sol 三部合唱! 把红 Do、黄 Mi、蓝 Sol 放到对应的山上~");const n=new Set;return s._level3Total=3,s._level3Count=0,s.fishPool.onTap=r=>{try{s.audio.playNote(r.dataset.pitch)}catch{}try{s.audio.hover(r.dataset.id)}catch{}N.fromTo(r,{scale:1},{scale:1.18,duration:.16,yoyo:!0,repeat:1,ease:"power2.out"})},s.fishPool.onDragStart=r=>{try{s.audio.hover(r.dataset.id)}catch{}},s.fishPool.onDragMove=(r,l)=>{},s.fishPool.onDrop=(r,l,o)=>{const a=r.dataset.id;if(n.has(a))return;let d=null,c=1/0;const g=r.getBoundingClientRect(),h=g.left+g.width/2,m=g.top+g.height/2;if(s.scene&&s.scene.background)for(const f of gn){const p=s.scene.background.querySelector(`[data-note="${f}"]`);if(!p)continue;const y=p.getBoundingClientRect(),v=y.left+y.width/2,b=y.top+y.height/2,x=Math.hypot(v-h,b-m);x<c&&(c=x,d=f)}const _=zs.find(f=>f.id===a),u=d&&c<ca;if(u&&a===d){n.add(d),s._level3Count=n.size;try{s.audio.correct()}catch{}try{s.scene.setProgress(n.size)}catch{}const f=s.scene.background.querySelector(`[data-note="${d}"]`),p=f.getBoundingClientRect(),y=s.fishPool.root.getBoundingClientRect(),v=p.left-y.left+p.width/2,b=p.top-y.top+p.height/2,x=parseFloat(r.style.left)||0,S=parseFloat(r.style.top)||0,w=v-x-r.offsetWidth/2,L=b-S-r.offsetHeight/2,T=_&&_.color||"#ffd166";N.to(r,{x:w,y:L,scale:.85,duration:.55,ease:"back.out(1.7)",onComplete:()=>{try{s.fishPool.lockFish(a)}catch{}try{s.audio.playNote(_.pitch)}catch{}try{s._floatScore(h,m,`${_.solfege} ✓`)}catch{}try{const E=f.getBoundingClientRect();s.scene.bloomAt(E.left+E.width/2,E.bottom,T)}catch{}N.to(r,{rotation:"+=8",transformOrigin:"50% 50%",duration:.12,yoyo:!0,repeat:5,ease:"sine.inOut",onComplete:()=>N.to(r,{rotation:0,duration:.2,ease:"power2.out"})}),N.fromTo(r,{scale:.85},{scale:1.05,duration:.18,yoyo:!0,repeat:1,ease:"power2.out"});const C=da[n.size-1]+" "+n.size+" / 3";s.say(C),n.size===3&&setTimeout(()=>{const E=s._calcStars();try{s.progress.markLevelComplete(3,E)}catch{}try{s.audio.playScale(["C4","E4","G4"])}catch{}try{s.showWinOverlay(E,3)}catch{}},700)}})}else{s.wrongCount++;try{s.audio.wrong()}catch{}if(r.classList.add("shake"),setTimeout(()=>r.classList.remove("shake"),400),!gn.has(a)){try{s.scene.shakePlatforms()}catch{}s.say(`${_.solfege} 不在 Do Mi Sol 里哦! 找红色 Do、黄色 Mi、蓝色 Sol 三座山~`),N.to(r,{x:0,y:0,duration:.9,ease:"elastic.out(1.2, 0.4)"}),N.fromTo(r,{rotation:"+=15"},{rotation:0,duration:.4,ease:"power2.out"})}else if(u){const p=zs.find(y=>y.id===d);s.say(`${_.solfege} 应该去另一座山, 不是 ${p?p.solfege:"那座"} 的位置~`),N.to(r,{x:0,y:0,duration:.55,ease:"elastic.out(1, 0.5)"})}else s.say(`${_.solfege} 应该去山上相应的高度哦~`),N.to(r,{x:0,y:0,duration:.55,ease:"elastic.out(1, 0.5)"})}},()=>{if(s.scene){try{s.scene.teardown()}catch{}s.scene=null}if(s.fishPool)try{s.fishPool.pool.innerHTML=""}catch{}const r=document.getElementById("hud-level2");r&&(r.style.display="");const l=document.querySelector(".hud__dots");l&&(l.style.display="");const o=document.getElementById("btn-replay");o&&(o.style.display=""),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const ha=Object.freeze(Object.defineProperty({__proto__:null,default:ua},Symbol.toStringTag,{value:"Module"}));class fa{constructor(e){this.stage=e,this.render()}render(){const e=document.createElement("div");e.className="level4-background",e.innerHTML=`
      <svg viewBox="0 0 800 500" preserveAspectRatio="xMidYMid slice"
           xmlns="${de}">
        <!-- === 顶部小河 (河流动画) === -->
  ...
  `),s.kb=new gt(s.stage,[{id:"do",solfege:"Do",pitch:"C4",note:"C",color:"#e63946"},{id:"re",solfege:"Re",pitch:"D4",note:"D",color:"#f4a261"},{id:"mi",solfege:"Mi",pitch:"E4",note:"E",color:"#ffc971"},{id:"fa",solfege:"Fa",pitch:"F4",note:"F",color:"#b5c99a"},{id:"sol",solfege:"Sol",pitch:"G4",note:"G",color:"#457b9d"},{id:"la",solfege:"La",pitch:"A4",note:"A",color:"#6a4c93"},{id:"si",solfege:"Si",pitch:"B4",note:"B",color:"#9b5de5"}]),s._level5Seq=[...ka],s._level5Total=s._level5Seq.length,s._level5Correct=0,s._level5Idx=0,s._level5Accepting=!0,s._level5Done=!1,s._level5EasyMode=!1,s._level5ConsecWrong=0;const r={do:180,re:165,mi:120,fa:110,sol:100,la:80,si:70};function l(){return n.querySelector(".level5-current-note")}function o(g,h){const m=document.getElementById("level5-bpm"),_=document.getElementById("level5-mode");m&&(m.textContent=String(g)),_&&(_.textContent=h);const u=document.getElementById("level5-metronome");u&&u.classList.toggle("level5-metronome--easy",!0)}function a(){const g=s._level5Idx||0,h=s._level5Total||14,_=4+Math.min(1,g/Math.max(1,h-1))*1.5;return s._level5EasyMode?_+1.5:_}function d(){if(!s._level5EasyMode&&s._level5ConsecWrong>=3){s._level5EasyMode=!0,o(Sa,"轻松模式");try{s.say("进入轻松模式~ 慢慢来不着急!")}catch{}}}function c(){if(s._level5Done||s._level5Idx>=s._level5Seq.length)return;const g=s._level5Seq[s._level5Idx],h=Ys[g],m=r[h.id],_=l();if(!_)return;N.killTweensOf(_),N.set(_,{scale:1}),_.setAttribute("cy",m),_.dataset.pitch=g,_.classList.remove("dropping","incorrect"),s.say(`下一个: ${h.solfege} (${g})`),s._level5Accepting=!0;const u=a();N.fromTo(_,{attr:{cy:m},opacity:1},{attr:{cy:m+100},opacity:.9,duration:u,ease:"none",onComplete:()=>{if(!s._level5Done&&s._level5Accepting){s._level5Accepting=!1,s.wrongCount++,s._level5ConsecWrong++,d();try{s.audio.wrong()}catch{}s.say("漏拍啦! 看下一个音符~"),_.classList.add("incorrect"),setTimeout(()=>{_.classList.remove("incorrect"),s._level5Idx++,c()},600)}}})}return s.kb.onPress=g=>{if(!s._level5Accepting||s._level5Done)return;const h=s._level5Seq[s._level5Idx],m=g.dataset.pitch;if(m===h){s._level5Correct++,s._level5Accepting=!1,s._level5ConsecWrong=0;try{s.audio.correct()}catch{}try{s.audio.playNote(m)}catch{}const _=l();_&&(N.killTweensOf(_),N.to(_,{opacity:0,scale:2,duration:.4,ease:"back.out(2)"})),s.say(["完美!","星星在向你眨眼!","小星星~"][Math.min(s._level5Correct-1,2)]),s._level5Idx++,s._level5Idx>=s._level5Seq.length?(s._level5Done=!0,setTimeout(()=>{const u=s._calcStars();try{s.progress.markLevelComplete(5,u)}catch{}try{s.audio.playScale(["C4","C4","G4","G4","A4","A4","G4"])}catch{}s.say("✨ 完美的《小星星》!"),s.showWinOverlay(u,5)},800)):setTimeout(c,500)}else{s.wrongCount++,s._level5ConsecWrong++,d();try{s.audio.wrong()}catch{}const _=Ys[m];s.say(`这是 ${_?_.solfege:"?"}, 不是 ${Ys[h].solfege}. 再听一下!`);const u=l();u&&u.classList.add("incorrect"),setTimeout(()=>{u&&u.classList.remove("incorrect")},300);try{s.audio.playNote(h)}catch{}}},setTimeout(c,1e3),()=>{s.scene&&typeof s.scene.teardown=="function"&&s.scene.teardown(),i&&i.parentNode&&i.remove();const g=n&&n.querySelector(".level5-current-note");g&&N.killTweensOf(g),s.stage.querySelectorAll(".level5-staff-area").forEach(u=>u.remove());const h=document.getElementById("level5-metronome");h&&h.remove();const m=document.getElementById("hud-level2");m&&(m.style.display="");const _=document.querySelector(".hud__dots");_&&(_.style.display="none"),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const Ca=Object.freeze(Object.defineProperty({__proto__:null,default:La},Symbol.toStringTag,{value:"Module"}));class Ma{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level6-background",e.innerHTML=`
      <svg viewBox="0 0 800 500" preserveAspectRatio="xMidYMid slice"
           xmlns="${de}">
        <!-- 装饰墙画 (圆点) -->
  ...
  `,document.head.appendChild(r),s.scene=new Ma(s.stage),s.kb=new gt(s.stage,Ce),setTimeout(()=>{!s.kb||!s.kb.svg||Ce.forEach(h=>{const m=s.kb.svg.querySelector(`.key--white[data-id="${h.id}"]`);if(!m)return;Us.has(h.id)?m.classList.add("level6-lh"):Ea.has(h.id)&&m.classList.add("level6-rh");const _=m.querySelector(".key__label");if(_){const u=document.createElementNS("http://www.w3.org/2000/svg","text"),f=_.getAttribute("x")||"40";u.setAttribute("x",f),u.setAttribute("y","150"),u.setAttribute("text-anchor","middle"),u.setAttribute("font-family","'ZCOOL KuaiLe', sans-serif"),u.setAttribute("font-size","12"),u.setAttribute("font-weight","900"),u.setAttribute("fill",Us.has(h.id)?"#2d6e3e":"#a06800"),u.setAttribute("class","level6-hand-tag"),u.setAttribute("style","pointer-events: none; paint-order: stroke; stroke: white; stroke-width: 2;"),u.textContent=Us.has(h.id)?"左手":"右手",m.appendChild(u)}})},50),s.say("钢琴老师教双手协调! 左低右高, 同时按下两个键~ 🎹"),s._level6Idx=0,s._level6Total=Bt.length,s._level6Correct=0,s._level6Done=!1,s._level6Current=null,s._level6PressFirst=null,s._level6PairTimer=null,s._level6Locked=!1;function l(h){!s.kb||!s.kb.svg||[h.high,h.low].forEach(m=>{const _=s.kb.svg.querySelector(`.key--white[data-id="${m}"]`);_&&s.kb.glowKey(_)})}function o(h,m){try{s.audio.playNote(h),setTimeout(()=>{try{s.audio.playNote(m)}catch{}},8)}catch{}}function a(h){if(h>=Bt.length)return d();const m=Bt[h];s._level6Current=m,s._level6PressFirst=null,s._level6Locked=!1;const _=Ce.find(f=>f.id===m.high),u=Ce.find(f=>f.id===m.low);s.say(`第 ${h+1} / ${Bt.length} 题: 请同时按 ${_.solfege} (右手) + ${u.solfege} (左手) ✨`);try{s.scene.setChordLabel(m.label)}catch{}setTimeout(()=>l(m),300),setTimeout(()=>{try{o(_.pitch,u.pitch)}catch{}},600)}function d(){s._level6Done=!0;const h=s._calcStars();try{s.progress.markLevelComplete(6,h)}catch{}try{s.audio.playScale(Pa)}catch{}s.say("双手小钢琴家毕业! 🎓🎹");try{s.scene.setChordLabel("毕业啦")}catch{}setTimeout(()=>{try{s.showWinOverlay(h,6)}catch{}},1200)}s.kb.onPress=h=>{if(s._level6Done||s._level6Locked||!s._level6Current||!h||!h.classList.contains("key--white"))return;const m=h.dataset.id,_=s._level6Current,u=new Set([_.high,_.low]),f=s._level6PressFirst;if(f&&f.id!==m){if(u.has(m)&&u.has(f.id)&&f.id!==m){c(h);return}g(h,m);return}if(!f){if(!u.has(m)){g(h,m);return}s._level6PressFirst={id:m,at:Date.now()};try{s.audio.playNote(h.dataset.pitch)}catch{}try{s.kb.glowKey(h)}catch{}h.classList.add("level6-pressed"),setTimeout(()=>h.classList.remove("level6-pressed"),500),s._level6PairTimer&&clearTimeout(s._level6PairTimer),s._level6PairTimer=setTimeout(()=>{const p=s._level6PressFirst;if(p){const y=Ce.find(x=>x.id===p.id),v=Ce.find(x=>x.id===_.high),b=Ce.find(x=>x.id===_.low);s.say(`光按了 ${y?y.solfege:"?"} 还不够哦, 再按 ${v.solfege} (右手) 或 ${b.solfege} (左手)~`),s.wrongCount++}s._level6PressFirst=null},Aa);return}try{s.kb.glowKey(h)}catch{}try{s.audio.playNote(h.dataset.pitch)}catch{}};function c(h){const m=s._level6PressFirst;if(!m||!s._level6Current)return;const _=m.id,u=h.dataset.id,f=Ce.find(v=>v.id===_),p=Ce.find(v=>v.id===u);if(f&&p)o(f.pitch,p.pitch);else try{f&&s.audio.playNote(f.pitch),p&&s.audio.playNote(p.pitch)}catch{}[_,u].forEach(v=>{const b=s.kb.svg.querySelector(`.key--white[data-id="${v}"]`);if(b){b.classList.add("level6-pressed");try{s.kb.glowKey(b)}catch{}setTimeout(()=>b.classList.remove("level6-pressed"),500)}}),s._level6Correct++,s._level6Locked=!0,s._level6PairTimer&&(clearTimeout(s._level6PairTimer),s._level6PairTimer=null),s._level6PressFirst=null;const y=xn[Math.min(s._level6Correct-1,xn.length-1)];s.say(`${y} 双音 ${s._level6Correct} / ${Bt.length}`),n[s._level6Correct-1]&&n[s._level6Correct-1].classList.add("on");try{s.scene.celebrateClap()}catch{}try{s._floatScore(window.innerWidth/2,window.innerHeight*.45,"🎵 双音!")}catch{}try{const v=document.createElement("div");v.className="level6-flash",document.body.appendChild(v),setTimeout(()=>v.remove(),600)}catch{}try{const v=h.getBoundingClientRect(),b=v.left+v.width/2,x=v.top+v.height/2,S=(Ce.find(w=>w.id===s._level6Current.high)||{}).color||"#ffd166";s.burst(b,x,S)}catch{}try{s.audio.correct()}catch{}s._level6Idx++,setTimeout(()=>a(s._level6Idx),1400)}function g(h,m){s.wrongCount++;try{s.audio.wrong()}catch{}if(h.classList.add("shake"),setTimeout(()=>h.classList.remove("shake"),400),s._level6PairTimer&&(clearTimeout(s._level6PairTimer),s._level6PairTimer=null),s._level6PressFirst=null,!s._level6Current)return;const _=Ce.find(p=>p.id===s._level6Current.high),u=Ce.find(p=>p.id===s._level6Current.low),f=Ce.find(p=>p.id===m);f?s.say(`${f.solfege} 不在本道题里, 要按 ${_.solfege} (右手) + ${u.solfege} (左手) 同时哦~`):s.say(`要同时按 ${_.solfege} (右手) + ${u.solfege} (左手) 哦~`),setTimeout(()=>l(s._level6Current),800)}return setTimeout(()=>a(0),1200),()=>{if(s._level6PairTimer&&(clearTimeout(s._level6PairTimer),s._level6PairTimer=null),r&&r.parentNode&&r.remove(),s.scene){try{s.scene.teardown()}catch{}s.scene=null}e&&(e.style.display=""),t&&(t.style.display=""),i&&(i.style.display=""),n.forEach(h=>{h.classList.remove("on"),h.style.display=""}),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const Da=Object.freeze(Object.defineProperty({__proto__:null,default:$a},Symbol.toStringTag,{value:"Module"}));class Oa{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level7-background",e.innerHTML=`
      <svg viewBox="0 0 800 500" preserveAspectRatio="xMidYMid slice"
           xmlns="${de}">
        <!-- 太阳 -->
...
`);try{M=new Worker(URL.createObjectURL(new Blob([B])))}catch(q){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",q),null}I(M)}return M}}(),m={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function _(M,k){return k?k(M):M}function u(M){return M!=null}function f(M,k,D){return _(M&&u(M[k])?M[k]:m[k],D)}function p(M){return M<0?0:Math.floor(M)}function y(M,k){return Math.floor(Math.random()*(k-M))+M}function v(M){return parseInt(M,16)}function b(M){return M.map(x)}function x(M){var k=String(M).replace(/[^0-9a-f]/gi,"");return k.length<6&&(k=k[0]+k[0]+k[1]+k[1]+k[2]+k[2]),{r:v(k.substring(0,2)),g:v(k.substring(2,4)),b:v(k.substring(4,6))}}function S(M){var k=f(M,"origin",Object);return k.x=f(k,"x",Number),k.y=f(k,"y",Number),k}function w(M){M.width=document.documentElement.clientWidth,M.height=document.documentElement.clientHeight}function L(M){var k=M.getBoundingClientRect();M.width=k.width,M.height=k.height}function T(M){var k=document.createElement("canvas");return k.style.position="fixed",k.style.top="0px",k.style.left="0px",k.style.pointerEvents="none",k.style.zIndex=M,k}function C(M,k,D,I,B,q,H,F,j){M.save(),M.translate(k,D),M.rotate(q),M.scale(I,B),M.arc(0,0,1,H,F,j),M.restore()}function E(M){var k=M.angle*(Math.PI/180),D=M.spread*(Math.PI/180);return{x:M.x,y:M.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:M.startVelocity*.5+Math.random()*M.startVelocity,angle2D:-k+(.5*D-Math.random()*D),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:M.color,shape:M.shape,tick:0,totalTicks:M.ticks,decay:M.decay,drift:M.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:M.gravity*3,ovalScalar:.6,scalar:M.scalar,flat:M.flat}}function A(M,k){k.x+=Math.cos(k.angle2D)*k.velocity+k.drift,k.y+=Math.sin(k.angle2D)*k.velocity+k.gravity,k.velocity*=k.decay,k.flat?(k.wobble=0,k.wobbleX=k.x+10*k.scalar,k.wobbleY=k.y+10*k.scalar,k.tiltSin=0,k.tiltCos=0,k.random=1):(k.wobble+=k.wobbleSpeed,k.wobbleX=k.x+10*k.scalar*Math.cos(k.wobble),k.wobbleY=k.y+10*k.scalar*Math.sin(k.wobble),k.tiltAngle+=.1,k.tiltSin=Math.sin(k.tiltAngle),k.tiltCos=Math.cos(k.tiltAngle),k.random=Math.random()+2);var D=k.tick++/k.totalTicks,I=k.x+k.random*k.tiltCos,B=k.y+k.random*k.tiltSin,q=k.wobbleX+k.random*k.tiltCos,H=k.wobbleY+k.random*k.tiltSin;if(M.fillStyle="rgba("+k.color.r+", "+k.color.g+", "+k.color.b+", "+(1-D)+")",M.beginPath(),l&&k.shape.type==="path"&&typeof k.shape.path=="string"&&Array.isArray(k.shape.matrix))M.fill(G(k.shape.path,k.shape.matrix,k.x,k.y,Math.abs(q-I)*.1,Math.abs(H-B)*.1,Math.PI/10*k.wobble));else if(k.shape.type==="bitmap"){var F=Math.PI/10*k.wobble,j=Math.abs(q-I)*.1,V=Math.abs(H-B)*.1,X=k.shape.bitmap.width*k.scalar,U=k.shape.bitmap.height*k.scalar,ee=new DOMMatrix([Math.cos(F)*j,Math.sin(F)*j,-Math.sin(F)*V,Math.cos(F)*V,k.x,k.y]);ee.multiplySelf(new DOMMatrix(k.shape.matrix));var oe=M.createPattern(c.transform(k.shape.bitmap),"no-repeat");oe.setTransform(ee),M.globalAlpha=1-D,M.fillStyle=oe,M.fillRect(k.x-X/2,k.y-U/2,X,U),M.globalAlpha=1}else if(k.shape==="circle")M.ellipse?M.ellipse(k.x,k.y,Math.abs(q-I)*k.ovalScalar,Math.abs(H-B)*k.ovalScalar,Math.PI/10*k.wobble,0,2*Math.PI):C(M,k.x,k.y,Math.abs(q-I)*k.ovalScalar,Math.abs(H-B)*k.ovalScalar,Math.PI/10*k.wobble,0,2*Math.PI);else if(k.shape==="star")for(var W=Math.PI/2*3,fe=4*k.scalar,ye=8*k.scalar,J=k.x,se=k.y,ue=5,ie=Math.PI/ue;ue--;)J=k.x+Math.cos(W)*ye,se=k.y+Math.sin(W)*ye,M.lineTo(J,se),W+=ie,J=k.x+Math.cos(W)*fe,se=k.y+Math.sin(W)*fe,M.lineTo(J,se),W+=ie;else M.moveTo(Math.floor(k.x),Math.floor(k.y)),M.lineTo(Math.floor(k.wobbleX),Math.floor(B)),M.lineTo(Math.floor(q),Math.floor(H)),M.lineTo(Math.floor(I),Math.floor(k.wobbleY));return M.closePath(),M.fill(),k.tick<k.totalTicks}function P(M,k,D,I,B){var q=k.slice(),H=M.getContext("2d"),F,j,V=d(function(X){function U(){F=j=null,H.clearRect(0,0,I.width,I.height),c.clear(),B(),X()}function ee(){i&&!(I.width===n.width&&I.height===n.height)&&(I.width=M.width=n.width,I.height=M.height=n.height),!I.width&&!I.height&&(D(M),I.width=M.width,I.height=M.height),H.clearRect(0,0,I.width,I.height),q=q.filter(function(oe){return A(H,oe)}),q.length?F=g.frame(ee):U()}F=g.frame(ee),j=U});return{addFettis:function(X){return q=q.concat(X),V},canvas:M,promise:V,reset:function(){F&&g.cancel(F),j&&j()}}}function $(M,k){var D=!M,I=!!f(k||{},"resize"),B=!1,q=f(k,"disableForReducedMotion",Boolean),H=r&&!!f(k||{},"useWorker"),F=H?h():null,j=D?w:L,V=M&&F?!!M.__confetti_initialized:!1,X=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,U;function ee(W,fe,ye){for(var J=f(W,"particleCount",p),se=f(W,"angle",Number),ue=f(W,"spread",Number),ie=f(W,"startVelocity",Number),Fe=f(W,"decay",Number),xt=f(W,"gravity",Number),Ke=f(W,"drift",Number),ct=f(W,"colors",b),Ds=f(W,"ticks",Number),es=f(W,"shapes"),Nr=f(W,"scalar"),Rr=!!f(W,"flat"),Fi=S(W),qi=J,Os=[],Ir=M.width*Fi.x,Br=M.height*Fi.y;qi--;)Os.push(E({x:Ir,y:Br,angle:se,spread:ue,startVelocity:ie,color:ct[qi%ct.length],shape:es[y(0,es.length)],ticks:Ds,decay:Fe,gravity:xt,drift:Ke,scalar:Nr,flat:Rr}));return U?U.addFettis(Os):(U=P(M,Os,j,fe,ye),U.promise)}function oe(W){var fe=q||f(W,"disableForReducedMotion",Boolean),ye=f(W,"zIndex",Number);if(fe&&X)return d(function(ie){ie()});D&&U?M=U.canvas:D&&!M&&(M=T(ye),document.body.appendChild(M)),I&&!V&&j(M);var J={width:M.width,height:M.height};F&&!V&&F.init(M),V=!0,F&&(M.__confetti_initialized=!0);function se(){if(F){var ie={getBoundingClientRect:function(){if(!D)return M.getBoundingClientRect()}};j(ie),F.postMessage({resize:{width:ie.width,height:ie.height}});return}J.width=J.height=null}function ue(){U=null,I&&(B=!1,e.removeEventListener("resize",se)),D&&M&&(document.body.contains(M)&&document.body.removeChild(M),M=null,V=!1)}return I&&!B&&(B=!0,e.addEventListener("resize",se,!1)),F?F.fire(W,J,ue):ee(W,J,ue)}return oe.reset=function(){F&&F.reset(),U&&U.reset()},oe}var O;function R(){return O||(O=$(null,{useWorker:!0,resize:!0})),O}function G(M,k,D,I,B,q,H){var F=new Path2D(M),j=new Path2D;j.addPath(F,new DOMMatrix(k));var V=new Path2D;return V.addPath(j,new DOMMatrix([Math.cos(H)*B,Math.sin(H)*B,-Math.sin(H)*q,Math.cos(H)*q,D,I])),V}function Z(M){if(!l)throw new Error("path confetti are not supported in this browser");var k,D;typeof M=="string"?k=M:(k=M.path,D=M.matrix);var I=new Path2D(k),B=document.createElement("canvas"),q=B.getContext("2d");if(!D){for(var H=1e3,F=H,j=H,V=0,X=0,U,ee,oe=0;oe<H;oe+=2)for(var W=0;W<H;W+=2)q.isPointInPath(I,oe,W,"nonzero")&&(F=Math.min(F,oe),j=Math.min(j,W),V=Math.max(V,oe),X=Math.max(X,W));U=V-F,ee=X-j;var fe=10,ye=Math.min(fe/U,fe/ee);D=[ye,0,0,ye,-Math.round(U/2+F)*ye,-Math.round(ee/2+j)*ye]}return{type:"path",path:k,matrix:D}}function be(M){var k,D=1,I="#000000",B='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof M=="string"?k=M:(k=M.text,D="scalar"in M?M.scalar:D,B="fontFamily"in M?M.fontFamily:B,I="color"in M?M.color:I);var q=10*D,H=""+q+"px "+B,F=new OffscreenCanvas(q,q),j=F.getContext("2d");j.font=H;var V=j.measureText(k),X=Math.ceil(V.actualBoundingBoxRight+V.actualBoundingBoxLeft),U=Math.ceil(V.actualBoundingBoxAscent+V.actualBoundingBoxDescent),ee=2,oe=V.actualBoundingBoxLeft+ee,W=V.actualBoundingBoxAscent+ee;X+=ee+ee,U+=ee+ee,F=new OffscreenCanvas(X,U),j=F.getContext("2d"),j.font=H,j.fillStyle=I,j.fillText(k,oe,W);var fe=1/D;return{type:"bitmap",bitmap:F.transferToImageBitmap(),matrix:[fe,0,0,fe,-X*fe/2,-U*fe/2]}}t.exports=function(){return R().apply(this,arguments)},t.exports.reset=function(){R().reset()},t.exports.create=$,t.exports.shapeFromPath=Z,t.exports.shapeFromText=be})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),Bi,!1);const Ze=Bi.exports;Bi.exports.create;class Na{burst({x:e,y:t,color:i="#ffd166",count:n=20,spread:r=50,startVelocity:l=22}){try{Ze({particleCount:n,spread:r,startVelocity:l,ticks:60,origin:{x:e/window.innerWidth,y:t/window.innerHeight},colors:[i,"#fff8ec","#ffc971"],shapes:["circle","square"],scalar:.7})}catch{}}celebrate({count:e=140,spread:t=80}={}){try{Ze({particleCount:e,spread:t,origin:{y:.55},colors:["#e63946","#f4a261","#ffc971","#b5c99a","#457b9d","#9b5de5"]})}catch{}}fountain({x:e,y:t,color:i="#ffd166",count:n=60}){try{const r={x:e/window.innerWidth,y:t/window.innerHeight};Ze({particleCount:n/2,angle:60,spread:55,origin:r,colors:[i,"#fff8ec"],startVelocity:35}),Ze({particleCount:n/2,angle:120,spread:55,origin:r,colors:[i,"#fff8ec"],startVelocity:35})}catch{}}confettiFromSides({count:e=50}={}){try{Ze({particleCount:e,angle:60,spread:55,origin:{x:0,y:.7}}),Ze({particleCount:e,angle:120,spread:55,origin:{x:1,y:.7}})}catch{}}firework({x:e,y:t,color:i="#ffd166"}={}){try{const n={x:e/window.innerWidth,y:t/window.innerHeight};Ze({particleCount:30,spread:360,startVelocity:25,origin:n,colors:[i,"#fff8ec","#ffc971","#9b5de5"],scalar:.8})}catch{}}drop({x:e,y:t,color:i="#a8dadc"}={}){try{const n={x:e/window.innerWidth,y:t/window.innerHeight};Ze({particleCount:12,spread:25,startVelocity:18,origin:n,colors:[i,"#fff8ec","#5fa8b5"],scalar:.5})}catch{}}}const Ht=new Na,Qs=[{id:"do",solfege:"Do",pitch:"C4",note:"C",color:"#e63946"},{id:"re",solfege:"Re",pitch:"D4",note:"D",color:"#f4a261"},{id:"mi",solfege:"Mi",pitch:"E4",note:"E",color:"#ffc971"},{id:"fa",solfege:"Fa",pitch:"F4",note:"F",color:"#b5c99a"},{id:"sol",solfege:"Sol",pitch:"G4",note:"G",color:"#457b9d"},{id:"la",solfege:"La",pitch:"A4",note:"A",color:"#6a4c93"},{id:"si",solfege:"Si",pitch:"B4",note:"B",color:"#9b5de5"}],Ra=36,Ks=["C4","D4","E4","F4","G4","A4","B4"],Ia=["B4","A4","G4","F4","E4","D4","C4"],Ba=new Set(["sol","la","si"]),wn=["完美!","真棒!","不错哟!","完整 7 音在聚集!"];function Fa(s){typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=7);const e=document.getElementById("hud-level2");e&&(e.style.display="none");const t=document.querySelector(".hud__dots");t&&(t.style.display="");const i=document.getElementById("btn-replay");i&&(i.style.display=""),s.scene=new Oa(s.stage),s.say("爬上树屋看完整 7 音阶! Fa 和 Si 是新的朋友~ 拖鱼到对应台阶 (Do 最低 → Si 最高)"),s.fishPool=new Ls(s.stage,Qs),s.fishPool.setDragEnabled(!0),s.fishPool.intro();const n=["do","re","mi","fa","sol","la","si"];s._level7Placed=new Set,s._level7Count=0,s.fishPool.onTap=l=>{if(l){try{s.audio.playNote(l.dataset.pitch)}catch{}try{s.audio.hover(l.dataset.id)}catch{}N.fromTo(l,{scale:1},{scale:1.18,duration:.16,yoyo:!0,repeat:1,ease:"power2.out"})}},s.fishPool.onDragStart=l=>{try{s.audio.hover(l.dataset.id)}catch{}},s.fishPool.onDragMove=()=>{},s.fishPool.onDrop=(l,o,a)=>{const d=l.dataset.id;if(s._level7Placed.has(d))return;const c=l.getBoundingClientRect(),g=c.left+c.width/2,h=c.top+c.height/2;let m=null,_=1/0;if(s.scene&&s.scene.background)for(const p of n){const y=s.scene.background.querySelector(`.level7-step[data-note="${p}"]`);if(!y)continue;const v=y.getBoundingClientRect(),b=v.left+v.width/2,x=v.top+v.height/2,S=Math.hypot(b-g,x-h);S<_&&(_=S,m=p)}const u=m&&_<Ra,f=Qs.find(p=>p.id===d);if(u&&d===m){s._level7Placed.add(d),s._level7Count=s._level7Placed.size;try{s.audio.correct()}catch{}const p=s.scene.background.querySelector(`.level7-step[data-note="${m}"]`),y=p.getBoundingClientRect(),v=y.left+y.width/2,b=y.top+y.height/2,x=parseFloat(l.style.left)||0,S=parseFloat(l.style.top)||0,w=v-c.left-x,L=b-c.top-S,T=f&&f.color||"#ffd166";try{s.scene.drawRibbon(m,{x:g,y:h},{x:v,y:b},T)}catch{}N.to(l,{x:w,y:L,scale:.85,duration:.55,ease:"back.out(1.7)",onComplete:()=>{try{s.fishPool.lockFish(d)}catch{}try{p.style.setProperty("--step-lit-color",T),p.classList.add("level7-step-lit")}catch{}try{Ht.fountain({x:v,y:b,color:T})}catch{}try{N.fromTo(p,{scale:1},{scale:1.25,duration:.3,yoyo:!0,repeat:1,ease:"power2.out"})}catch{}if(f){try{s.audio.playNote(f.pitch)}catch{}try{s._floatScore(g,h,`${f.solfege} ✓`)}catch{}}try{setTimeout(()=>{try{s.audio.hover(d)}catch{}},220)}catch{}try{const E=s.scene.background.querySelector(".level7-birds path");E&&N.fromTo(E,{y:0},{y:-6,duration:.12,yoyo:!0,repeat:3,ease:"sine.inOut",overwrite:!0})}catch{}if(N.to(l,{rotation:"+=8",transformOrigin:"50% 50%",duration:.12,yoyo:!0,repeat:5,ease:"sine.inOut",onComplete:()=>N.to(l,{rotation:0,duration:.2,ease:"power2.out"})}),N.fromTo(l,{scale:.85},{scale:1.05,duration:.18,yoyo:!0,repeat:1,ease:"power2.out"}),Ba.has(m)){try{const E=l;E.classList.add("level7-fish-lift"),setTimeout(()=>{try{E.classList.remove("level7-fish-lift")}catch{}},900)}catch{}try{p.classList.add("level7-step-glow")}catch{}}const C=wn[Math.min(s._level7Count-1,wn.length-1)]+" "+s._level7Count+" / 7";s.say(C),s._level7Count===7&&setTimeout(()=>r(),800)}})}else{s.wrongCount++;try{s.audio.wrong()}catch{}if(l.classList.add("shake"),setTimeout(()=>l.classList.remove("shake"),400),u&&m&&d!==m){const p=Qs.find(v=>v.id===m),y=m==="fa"?"Fa 在 Mi 和 Sol 之间 (第 4 级台阶)":m==="si"?"Si 在 La 之上, 最高一级台阶 (最接近树屋)":`${p?p.solfege:"这个台阶"}`;s.say(`${f?f.solfege:"这条鱼"} 不是 ${y} 的鱼哦~`)}else d==="fa"?s.say("Fa 是新朋友! 它在 Mi 和 Sol 之间的台阶~"):d==="si"?s.say("Si 是新朋友! 它在 La 之上, 最高的台阶, 最接近树屋~"):s.say(`${f?f.solfege:"这条鱼"} 的家在树上, 找最近的圆圈~`);N.to(l,{x:0,y:0,duration:.55,ease:"elastic.out(1, 0.5)"})}};function r(){const l=s._calcStars();try{s.progress.markLevelComplete(7,l)}catch{}try{s.scene.lightTreehouse()}catch{}try{s.audio.playScale(Ks)}catch{}s.say("完整的 Do Re Mi Fa Sol La Si 上行! 太棒了~"),setTimeout(()=>{try{s.audio.playScale(Ia)}catch{}s.say("再来下行: Si La Sol Fa Mi Re Do")},Ks.length*220+300),setTimeout(()=>{try{s.showWinOverlay(l,7)}catch{}},Ks.length*220*2+1200)}return()=>{if(s.scene){try{s.scene.teardown()}catch{}s.scene=null}if(s.fishPool)try{s.fishPool.pool.innerHTML=""}catch{}e&&(e.style.display=""),t&&(t.style.display=""),i&&(i.style.display=""),typeof window<"u"&&(window.__forestPiano=window.__forestPiano||{},window.__forestPiano.currentLevelId=null)}}const qa=Object.freeze(Object.defineProperty({__proto__:null,default:Fa},Symbol.toStringTag,{value:"Module"}));class Ha{constructor(e){this.stage=e,this.background=null,this.render()}render(){const e=document.createElement("div");e.className="level8-background",e.innerHTML=`
  ...
  `,document.head.appendChild(n),s.scene=new Ha(s.stage),s.say("森林音乐会开始! 选一首曲子~"),s.stage.insertAdjacentHTML("beforeend",'<div class="level8-song-stage"></div>');const r=s.stage.querySelector(".level8-song-stage"),l="fps_level8_played_v1";function o(){try{const y=localStorage.getItem(l);if(!y)return new Set;const v=JSON.parse(y);return new Set(Array.isArray(v)?v:[])}catch{return new Set}}function a(y){const v=o();v.add(y);try{localStorage.setItem(l,JSON.stringify(Array.from(v)))}catch{}}o().size>=6&&r.insertAdjacentHTML("beforeend",'<div class="level8-all-played-badge">🎖 全部演奏!</div>'),s.scene.showSongSelector(r,y=>u(y)),s.kb=new gt(s.stage,[{id:"do",solfege:"Do",pitch:"C4",note:"C",color:"#e63946"},{id:"re",solfege:"Re",pitch:"D4",note:"D",color:"#f4a261"},{id:"mi",solfege:"Mi",pitch:"E4",note:"E",color:"#ffc971"},{id:"fa",solfege:"Fa",pitch:"F4",note:"F",color:"#b5c99a"},{id:"sol",solfege:"Sol",pitch:"G4",note:"G",color:"#457b9d"},{id:"la",solfege:"La",pitch:"A4",note:"A",color:"#6a4c93"},{id:"si",solfege:"Si",pitch:"B4",note:"B",color:"#9b5de5"}]),s._level8Seq=null,s._level8Idx=0,s._level8Total=0,s._level8Correct=0,s._level8Accepting=!1,s._level8Done=!1,s._level8Timeouts=[];let c=null,g=null;function h(){const y=document.getElementById("level8-audience");y&&(y.classList.remove("level8-cheer"),y.getBoundingClientRect(),y.classList.add("level8-cheer"),clearTimeout(g),g=setTimeout(()=>y.classList.remove("level8-cheer"),700))}function m(){s.stage.insertAdjacentHTML("beforeend",'<div class="level8-staff-area"></div>'),c=s.stage.querySelector(".level8-staff-area"),c.innerHTML=`
    ...
    `}function _(){return c?c.querySelector(".level8-current-note"):null}function u(y){r&&(r.innerHTML=`
        <div class="level8-now-playing">
          <div class="level8-playing-badge">🎼 正在演奏</div>
          <div class="level8-now-emoji">${y.emoji}</div>
          <div class="level8-now-text">演奏: <strong>${y.name}</strong></div>
          <div class="level8-difficulty-badge level8-diff-${y.difficulty}">难度 ${y.diff}</div>
          <div class="level8-progress">1 / ${y.melody.length}</div>
        </div>
      `),c||m(),s.say(`演奏《${y.name}》! 跟着音符按琴键~`),a(y.id),s._level8Song=y,s._level8Seq=[...y.melody],s._level8Total=s._level8Seq.length,s._level8Correct=0,s._level8Idx=0,s._level8Accepting=!1,s._level8Done=!1,setTimeout(f,800)}function f(){if(s._level8Done||s._level8Idx>=s._level8Seq.length)return;const y=s._level8Seq[s._level8Idx],v=Zs[y],b=Ga[v.id],x=_();x&&(N.killTweensOf(x),N.set(x,{scale:1,opacity:1}),x.setAttribute("cy",b),x.dataset.pitch=y,x.classList.remove("incorrect"),s.say(`下一个: ${v.solfege} (${y})`),s._level8Accepting=!0,N.fromTo(x,{attr:{cy:b}},{attr:{cy:b+100},duration:4.5,ease:"none",onComplete:()=>{if(!s._level8Done&&s._level8Accepting){s._level8Accepting=!1,s.wrongCount++;try{s.audio.wrong()}catch{}s.say("漏拍啦! 看下一个音符~"),x.classList.add("incorrect"),setTimeout(()=>{x.classList.remove("incorrect"),s._level8Idx++,f()},600)}}}))}s.kb.onPress=y=>{if(!s._level8Accepting||s._level8Done||!s._level8Seq||s._level8Idx>=s._level8Seq.length)return;const v=s._level8Seq[s._level8Idx],b=y.dataset.pitch;if(b===v){s._level8Correct++,s._level8Accepting=!1;try{s.audio.correct()}catch{}try{s.audio.playNote(b)}catch{}const x=_();if(x&&(N.killTweensOf(x),N.to(x,{opacity:0,scale:2,duration:.4,ease:"back.out(2)"})),r){const w=r.querySelector(".level8-progress");w&&(w.textContent=`${s._level8Idx+1} / ${s._level8Total}`)}h();const S=["完美!","森林在听!","真棒!"];s.say(S[Math.min(s._level8Correct-1,S.length-1)]),s._level8Idx++,s._level8Idx>=s._level8Seq.length?(s._level8Done=!0,s._level8Timeouts.push(setTimeout(p,800))):setTimeout(f,500)}else{s.wrongCount++;try{s.audio.wrong()}catch{}const x=Zs[b];s.say(`这是 ${x?x.solfege:"?"}, 不是 ${Zs[v].solfege}. 再听一下!`);const S=_();S&&S.classList.add("incorrect"),setTimeout(()=>{S&&S.classList.remove("incorrect")},300);try{s.audio.playNote(v)}catch{}}};function p(){const y=s._level8Song,v=y&&y.difficulty||1,b=s.wrongCount||0;let x;v<=1?x=s._calcStars&&s._calcStars()||(b<=0?3:b<=2?2:b<=5?1:0):v===2?x=b<=0?3:b<=3?2:b<=7?1:0:x=b<=1?3:b<=4?2:b<=9?1:0;try{s.progress.markLevelComplete(8,x)}catch{}try{s.audio.playScale(["C4","D4","E4","F4","G4","A4","B4"])}catch{}if(typeof s._flashScreen=="function")try{s._flashScreen()}catch{}if(typeof s._floatScore=="function")try{s._floatScore(window.innerWidth/2,window.innerHeight*.4,"🎉 完美的表演! 🎉")}catch{}s.say("完美的表演! 森林在为你鼓掌!"),setTimeout(()=>{try{s.showWinOverlay(x,8)}catch{}},1200),s.stage.insertAdjacentHTML("beforeend",`
    ...
    `,document.body.appendChild(c);const g=c.querySelector("#win-share-btn");g&&(g.onclick=async()=>{try{const{Share:_}=await Je(async()=>{const{Share:f}=await import("./Share-yqeuLLwg.js");return{Share:f}},[],import.meta.url),u=new _(this);c.style.display="none",u.showShareMenu({levelId:t,stars:e,wrongCount:this.wrongCount,totalQuestions:t===2?this._level2Total||5:7},()=>{c.style.display=""})}catch(_){console.warn("[share] 打开分享菜单失败:",_)}});const h=c.querySelector("#next-btn");t===1?(h.textContent="第 2 关 ›",h.onclick=()=>{c.remove(),this.say("第二关马上来..."),this.start({levelId:2})}):(h.textContent="🎉 全部完成",h.onclick=()=>{c.remove(),this._showAllDoneOverlay()}),c.querySelector("#replay-btn").onclick=()=>{c.remove(),this.start({levelId:t})};const m=c.querySelector("#achievements-btn");m&&(m.onclick=async()=>{try{const{AchievementsWall:_}=await Je(async()=>{const{AchievementsWall:f}=await import("./AchievementsWall-Du7sqI7m.js");return{AchievementsWall:f}},[],import.meta.url);c.remove(),new _(document.body,{achievementSystem:this.achievements,onClose:()=>{this.showWinOverlay(e,t)}}).show()}catch(_){console.warn("[achievements] 打开成就墙失败:",_)}})}_showAllDoneOverlay(){document.querySelectorAll(".overlay").forEach(t=>t.remove());const e=document.createElement("div");e.className="overlay",e.innerHTML=`
      <div class="overlay__card">
    ...
    `;const r=this.element.querySelector("#tut-back"),l=this.element.querySelector("#tut-next"),o=this.element.querySelector("#tut-done"),a=this.element.querySelector("#tut-skip");r&&r.addEventListener("click",()=>this._prev()),l&&l.addEventListener("click",()=>this._next()),o&&o.addEventListener("click",()=>this._done()),a&&a.addEventListener("click",()=>this._done())}_prev(){this.currentPage>0&&(this.currentPage--,this._render())}_next(){this.currentPage<hs.length-1&&(this.currentPage++,this._render())}_done(){this.element&&this.element.parentNode&&(this.element.parentNode.removeChild(this.element),this.element=null),this.onDone&&this.onDone()}hide(){this._done()}}const pc=Object.freeze(Object.defineProperty({__proto__:null,Tutorial:mi},Symbol.toStringTag,{value:"Module"})),ei=[{id:"cream",name:"奶油橙",icon:"🍑",bg:"cream"},{id:"night",name:"夜色",icon:"🌙",bg:"night"},{id:"forest",name:"森林绿",icon:"🌲",bg:"forest"}],_c={cream:"🍑",night:"🌙",forest:"🌲"},Pn="forest-piano-theme",ti={cream:{"--bg-cream":"#fff8ec","--bg-paper":"#faf3e0","--staff-strong":"#3d405b","--warm-cta":"#ffb347","--text-main":"#3d405b","--text-sub":"#6b7280"},night:{"--bg-cream":"#1a1430","--bg-paper":"#251a3f","--staff-strong":"#fdf6e3","--warm-cta":"#ff8fb1","--text-main":"#fdf6e3","--text-sub":"#b8a5d0"},forest:{"--bg-cream":"#1a3a2a","--bg-paper":"#244a3a","--staff-strong":"#fdf6e3","--warm-cta":"#84cc16","--text-main":"#fdf6e3","--text-sub":"#a3c9a8"}};class vc{constructor(e){this.stage=e,this.current=this._load(),this._apply(),this.button=null}_load(){try{return localStorage.getItem(Pn)||"cream"}catch{return"cream"}}_save(e){try{localStorage.setItem(Pn,e)}catch{}}_apply(){const e=ti[this.current]||ti.cream;for(const[t,i]of Object.entries(e))document.documentElement.style.setProperty(t,i);document.body.dataset.theme=this.current}cycle(){const e=ei.findIndex(i=>i.id===this.current),t=ei[(e+1)%ei.length];return this.current=t.id,this._save(this.current),this._apply(),t}set(e){ti[e]&&(this.current=e,this._save(e),this._apply())}}class yc{constructor(e){this.game=e,this.enabled=!0,this._handler=t=>this._onKeyDown(t)}enable(){this.enabled||(this.enabled=!0,document.addEventListener("keydown",this._handler))}disable(){this.enabled&&(this.enabled=!1,document.removeEventListener("keydown",this._handler))}_onKeyDown(e){if(!(e.target&&(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"))){if(e.key==="Escape"||e.key==="Esc"){const t=document.querySelectorAll(".overlay, .achievements-wall, .settings-panel, .tutorial");if(t.length>0){const i=t[t.length-1];i.classList.contains("achievements-wall")?i.querySelector("#close-achievements")?.click():i.remove(),e.preventDefault()}else if(this.game&&typeof this.game._showStartOverlay=="function"){this.game._showStartOverlay(),e.preventDefault();return}}if(e.key==="Enter"){const i=document.querySelector(".overlay__card")?.querySelector("#start-btn");if(i){i.click(),e.preventDefault();return}}if(e.key==="m"||e.key==="M"){const t=document.getElementById("btn-sound");t&&t.click(),e.preventDefault()}if(/^[1-9]$/.test(e.key)){const t=parseInt(e.key,10);try{this.game.start({levelId:t}),e.preventDefault()}catch{}}if(e.key===" "){const t=document.querySelector(".level4-drum-anchor, .level12-cut-btn");t&&(t.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0})),e.preventDefault())}}}}const $n="forest-piano-streak";function mc(){const s=new Date;return`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`}class gc{constructor(){this.state=this._load()}_load(){try{const e=localStorage.getItem($n);if(e)return JSON.parse(e)}catch{}return{lastDate:null,streakCount:0,longestStreak:0}}_save(){try{localStorage.setItem($n,JSON.stringify(this.state))}catch{}}checkIn(){const e=mc();if(this.state.lastDate===e)return{streak:this.state.streakCount,isNew:!1};const t=(()=>{const i=new Date;return i.setDate(i.getDate()-1),`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}-${String(i.getDate()).padStart(2,"0")}`})();return this.state.lastDate===t?this.state.streakCount+=1:this.state.lastDate!==null?this.state.streakCount=1:this.state.streakCount=1,this.state.streakCount>this.state.longestStreak&&(this.state.longestStreak=this.state.streakCount),this.state.lastDate=e,this._save(),{streak:this.state.streakCount,isNew:!0}}get(){return{streak:this.state.streakCount,longest:this.state.longestStreak}}}const Dn=new vc,On="forest-piano-tutorial-shown",gi="v19.0";window.__forestPiano={Game:Dr,Audio:$s,Progress:Or,version:gi};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Nn):Nn();function Nn(){const s=document.getElementById("stage"),e=document.getElementById("bubble-text"),t=document.getElementById("version-tag");t&&(t.textContent=gi),bc();const i=new Dr({stageEl:s,bubbleEl:e,progress:new Or,audio:new $s}),n=new cc(i.audio);i.start({levelId:1});const r=new gc,l=r.checkIn();l.isNew&&l.streak>=3&&setTimeout(()=>{const p=document.createElement("div");p.className="streak-toast",p.innerHTML=`
      ...
      `,document.body.appendChild(p),setTimeout(()=>p.classList.add("show"),50),setTimeout(()=>{p.classList.remove("show"),setTimeout(()=>p.remove(),500)},5500)},3e3);const o=document.createElement("span");o.className="level-badge",o.id="level-badge",o.title="点击返回关卡地图",o.setAttribute("role","button"),o.setAttribute("aria-label","当前关卡 - 点击返回地图"),o.textContent="🐟 第 1 关 · 小鱼跳进五线谱";const a=document.querySelector(".hud__left");a&&a.insertBefore(o,a.firstChild),o.addEventListener("click",()=>{i.goHome()});const d=document.createElement("div");d.className="streak-badge",d.textContent=`🔥 ${l.streak}`,d.title=`连续 ${l.streak} 天, 最长 ${r.get().longest}`,document.querySelector(".hud__left")?.appendChild(d);const c=document.getElementById("btn-sound"),g=document.getElementById("btn-replay"),h=document.getElementById("btn-bgm"),m=document.getElementById("btn-home");c&&c.addEventListener("click",()=>{const p=i.audio.toggleMute();c.textContent=p?"🔇":"🔊"}),g&&g.addEventListener("click",()=>{try{i.restartLevel()}catch(p){console.warn("restart 失败:",p)}}),h&&h.addEventListener("click",()=>{const p=n.toggle();h.textContent=p?"🎶":"🔇",h.style.background=p?"rgba(255, 235, 168, 0.4)":""}),m&&m.addEventListener("click",()=>{i.goHome()});const _=document.createElement("button");_.className="hud__btn",_.id="btn-settings",_.setAttribute("aria-label","设置"),_.setAttribute("title","设置"),_.textContent="⚙",document.querySelector(".hud__right")?.appendChild(_),_.addEventListener("click",()=>{new fc(document.body,{version:gi,onReset:()=>location.reload(),onClose:()=>{}}).show()});const u=document.querySelector(".hud__right");if(u&&!document.getElementById("btn-achievements")){const p=document.createElement("button");p.className="hud__btn",p.id="btn-achievements",p.setAttribute("aria-label","成就墙"),p.title="成就墙",p.textContent="🏆",u.insertBefore(p,u.firstChild),p.addEventListener("click",()=>{Je(async()=>{const{AchievementsWall:y}=await import("./AchievementsWall-Du7sqI7m.js");return{AchievementsWall:y}},[],import.meta.url).then(({AchievementsWall:y})=>{new y(document.body,{achievementSystem:i.achievements,onClose:()=>{}}).show()}).catch(y=>console.warn("[achievements] 加载失败:",y))})}if(u&&!document.getElementById("btn-leaderboard")){const p=document.createElement("button");p.className="hud__btn",p.id="btn-leaderboard",p.setAttribute("aria-label","排行榜"),p.setAttribute("title","我的成就"),p.textContent="📊",u.appendChild(p),p.addEventListener("click",()=>{Je(async()=>{const{Leaderboard:y}=await import("./Leaderboard-D8B94zyK.js");return{Leaderboard:y}},[],import.meta.url).then(({Leaderboard:y})=>{new y(document.body,i.progress,i.achievements).show()}).catch(y=>console.warn("[leaderboard] 加载失败:",y))})}if(u&&!document.getElementById("btn-practice")){const p=document.createElement("button");p.className="hud__btn",p.id="btn-practice",p.setAttribute("aria-label","自由演奏"),p.title="自由演奏",p.textContent="🎹",u.appendChild(p),p.addEventListener("click",()=>{Je(async()=>{const{PracticeRoom:y}=await import("./PracticeRoom-DM_R1ZP2.js");return{PracticeRoom:y}},[],import.meta.url).then(({PracticeRoom:y})=>{new y(document.body,i).show()}).catch(y=>console.warn("[practice] 加载失败:",y))})}if(u&&!document.getElementById("btn-songs")){const p=document.createElement("button");p.className="hud__btn",p.id="btn-songs",p.setAttribute("aria-label","歌曲库"),p.title="歌曲库",p.textContent="🎵",u.appendChild(p),p.addEventListener("click",()=>{Je(async()=>{const{SongLibrary:y}=await import("./SongLibrary-CumQVr9F.js");return{SongLibrary:y}},[],import.meta.url).then(({SongLibrary:y})=>{new y(document.body,i).show()}).catch(y=>console.warn("[songs] 加载失败:",y))})}if(!document.getElementById("btn-help")){const p=document.createElement("button");p.className="hud__btn",p.id="btn-help",p.setAttribute("aria-label","帮助"),p.setAttribute("title","教程"),p.textContent="📖",document.querySelector(".hud__right")?.appendChild(p),p.addEventListener("click",()=>{new mi(document.body,{onDone:()=>{}}).show()})}if(!document.getElementById("btn-theme")){const p=document.createElement("button");p.className="hud__btn",p.id="btn-theme",p.setAttribute("aria-label","主题"),p.title="主题",p.textContent=_c[Dn.current]||"🎨",document.querySelector(".hud__right")?.appendChild(p),p.addEventListener("click",()=>{const y=Dn.cycle();p.textContent=y.icon;const v=document.createElement("div");v.className="theme-flash",v.textContent=`${y.icon} ${y.name}`,document.body.appendChild(v),setTimeout(()=>v.remove(),2e3)})}localStorage.getItem(On)||setTimeout(()=>{new mi(document.body,{isFirstTime:!0,onDone:()=>localStorage.setItem(On,"1")}).show()},1200),window.addEventListener("error",p=>{console.error("[forest-piano] error:",p.error)}),setTimeout(()=>{const p=document.getElementById("splash");p&&p.parentNode&&p.parentNode.removeChild(p)},2200),new yc(i).enable(),document.addEventListener("keydown",p=>{if(p.key==="?"||p.shiftKey&&p.key==="/"){const y=document.createElement("div");y.className="keyboard-help",y.innerHTML=`
